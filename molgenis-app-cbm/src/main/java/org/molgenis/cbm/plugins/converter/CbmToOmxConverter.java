...
import org.molgenis.cbm.jaxb.CollectionProtocol;
import org.molgenis.cbm.jaxb.Diagnosis;
...
public class CbmToOmxConverter extends PluginModel<Entity>
{
	...
	{
		return "plugins_converter_CbmToOmxConverter";
	}

	@Override
	public String getViewTemplate()
	{
		return "templates/org/molgenis/cbm/plugins/converter/CbmToOmxConverter.ftl";
	}
