...
public class RestControllerV2Test extends AbstractMolgenisSpringTest
{
	...
	public void beforeMethod() throws ParseException
	{
		...
		EntityType refRefEntityType =  null; //FIXME entityTypeFactory.create().setFullyQualifiedName(REF_REF_ENTITY_NAME)
...
//				.addAttribute(attributeFactory.create().setName(REF_REF_ATTR_VALUE_NAME));
		...
		EntityType selfRefEntityType =  null; //FIXME entityTypeFactory.create().setFullyQualifiedName(SELF_REF_ENTITY_NAME)
...
//				.addAttribute(attributeFactory.create().setName("id"), ROLE_ID, ROLE_LABEL, ROLE_LOOKUP);
		...
		EntityType refEntityType = null; //FIXME  entityTypeFactory.create().setFullyQualifiedName(REF_ENTITY_NAME).setLabel(REF_ENTITY_NAME)
...
//								.setRefEntity(refRefEntityType));
		...
		// required
		EntityType entityType =  null; //FIXME entityTypeFactory.create().setFullyQualifiedName(ENTITY_NAME).setLabel(ENTITY_NAME);
