...
public class AttributeFilterToFetchConverterTest
{
	...
	public void setUpBeforeMethod()
	{
		...
		selfRefEntityMetaData.addAttribute("label").setDataType(STRING).setLabelAttribute(true);
		...
		AttributeMetaData compoundPartAttr = when(mock(AttributeMetaData.class).getName()).thenReturn(
				COMPOUND_PART_ATTR_NAME).getMock();
		when(compoundPartAttr.getDataType()).thenReturn(STRING);
		AttributeMetaData compoundPartFileAttr = when(mock(AttributeMetaData.class).getName()).thenReturn(
				COMPOUND_PART_FILE_ATTR_NAME).getMock();
		...
		AttributeMetaData compoundAttr = when(mock(AttributeMetaData.class).getName()).thenReturn(COMPOUND_ATTR_NAME)
				.getMock();
		AttributeMetaData compoundPartCompoundAttr = when(mock(AttributeMetaData.class).getName()).thenReturn(
				COMPOUND_PART_COMPOUND_ATTR_NAME).getMock();
		when(compoundPartCompoundAttr.getDataType()).thenReturn(COMPOUND);

		AttributeMetaData compoundPartCompoundPartAttr = when(mock(AttributeMetaData.class).getName()).thenReturn(
				COMPOUND_PART_COMPOUND_PART_ATTR_NAME).getMock();
		when(compoundPartCompoundPartAttr.getDataType()).thenReturn(STRING);

		AttributeMetaData compoundPartCompoundPartAttr2 = when(mock(AttributeMetaData.class).getName()).thenReturn(
				COMPOUND_PART_COMPOUND_PART_ATTR2_NAME).getMock();
		when(compoundPartCompoundPartAttr2.getDataType()).thenReturn(STRING);

		when(compoundPartCompoundAttr.getAttributeParts()).thenReturn(
				Arrays.asList(compoundPartCompoundPartAttr, compoundPartCompoundPartAttr2));
		when(compoundPartCompoundAttr.getAttributePart(COMPOUND_PART_COMPOUND_PART_ATTR_NAME)).thenReturn(
				compoundPartCompoundPartAttr);
		...
		when(compoundPartCompoundAttr.getAttributePart(COMPOUND_PART_COMPOUND_PART_ATTR2_NAME)).thenReturn(
				compoundPartCompoundPartAttr2);
		...
		when(compoundAttr.getAttributeParts()).thenReturn(
				Arrays.asList(compoundPartAttr, compoundPartFileAttr, compoundPartCompoundAttr));
		...
		when(compoundAttr.getAttributePart(COMPOUND_PART_COMPOUND_ATTR_NAME.toLowerCase())).thenReturn(
				compoundPartCompoundAttr);
		...
		when(entityMeta.getAttribute(COMPOUND_PART_COMPOUND_ATTR_NAME.toLowerCase())).thenReturn(
				compoundPartCompoundAttr);
		when(entityMeta.getAttribute(COMPOUND_PART_COMPOUND_PART_ATTR_NAME)).thenReturn(compoundPartCompoundPartAttr);
		when(entityMeta.getAttribute(COMPOUND_PART_COMPOUND_PART_ATTR_NAME.toLowerCase())).thenReturn(
				compoundPartCompoundPartAttr);
		when(entityMeta.getAttribute(COMPOUND_PART_COMPOUND_PART_ATTR2_NAME)).thenReturn(compoundPartCompoundPartAttr2);
		when(entityMeta.getAttribute(COMPOUND_PART_COMPOUND_PART_ATTR2_NAME.toLowerCase())).thenReturn(
				compoundPartCompoundPartAttr2);
		...
		when(entityMeta.getAtomicAttributes()).thenReturn(
				Arrays.asList(idAttr, labelAttr, compoundPartAttr, compoundPartFileAttr, compoundPartCompoundPartAttr,
	...
	{
		AttributeFilter attrFilter = new AttributeFilter().add(
				COMPOUND_ATTR_NAME,
