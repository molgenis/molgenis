				...
				<div class="tab-pane" id="tab1">
     				<div class="row-fluid">
						...
						<select data-placeholder="Choose a Dataset" id="dataset-select">
							...
							<#else> 
								<option>No data sets available</option>
							</#if>	
						</select>
						</div>
						...
						<a type="button" class="btn" href="#data-set-upload-modal" data-toggle="modal">Upload or create a new Data set</a>
...
<div class="modal fade" id="data-set-upload-modal">
  	...
  	<form role="form" action="${context_url}/create-new-data-set-from-tsv" method="post" enctype="multipart/form-data" boundary="_FPSEP91465b27654aa128979fb2_">
  		<div class="modal-body">	
			<div class="form-group has-succes">	
				<label>Name of your new dataset</label>
				<input type="text" id="data-set-name" name="data-set-name" class="form-control" placeholder="enter your data set name here">
			</div>
		...
		<div class="modal-footer">
	    	...
	    	<a id="hideModal" href="#data-set-upload-modal" data-toggle="modal" class="btn">Cancel</a>
		</div>
	</form>
</div>
</#macro>
...
<script>
	...
	$('#createDataSet').click(function(){
		if($('#data-set-name').val() === null || $('#data-set-name').val().length === 0){
			//alert('Please define the dataset name!');
			$('#data-set-name').tooltip("destroy")
                  .data("title", 'Please define the dataset name!')
                  .addClass("error")
                  .tooltip();
			return false;
		}
