...
describe('actions', () => {
  ...
  describe('GET_PACKAGES', () => {
    ...
    it('should fail and create an alert in the state via a mutation', done => {
      ...
      const payload = {
        type: 'error',
        message: rejection + ' packages'
      }

      testAction(actions.__GET_PACKAGES__, null, {}, [{type: CREATE_ALERT, payload: payload}], [], done)
    })
  })
  ...
  describe('GET_ATTRIBUTE_TYPES', () => {
    ...
    it('should fail and create an alert in the state via a mutation', done => {
      ...
      const payload = {
        type: 'error',
        message: rejection + ' attribute types'
      }

      testAction(actions.__GET_ATTRIBUTE_TYPES__, null, {}, [{type: CREATE_ALERT, payload: payload}], [], done)
    })
  })
  ...
  describe('DELETE_ENTITY_TYPE', () => {
    ...
    it('should successfully delete an entity type', done => {
      ...
      const payload = {
        type: 'success',
        message: 'OK: Successfully deleted EntityType [1]'
      }
