<template>
  <div>
    ...
    <div class="row">
      <div class="col">
        <metadata-manager-entity-edit-form v-if="editorEntityType && editorEntityType.backend !== null"></metadata-manager-entity-edit-form>
        <hr>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col">
        <metadata-manager-attribute-edit-form v-if="editorEntityType && editorEntityType.backend !== null"></metadata-manager-attribute-edit-form>
      </div>
    </div>
  </div>
</template>
