...
public class EntityTypeMapperTest {
  ...
  public void testToEntityType() {
    ...
    List<EditorAttributeIdentifier> editorReferringAttributes =
        of(mock(EditorAttributeIdentifier.class));
  ...
  public void testToEditorEntityType() {
    ...
    when(attributeReferenceMapper.toEditorAttributeIdentifiers(referringAttributes))
        .thenReturn(editorReferringAttributes);
