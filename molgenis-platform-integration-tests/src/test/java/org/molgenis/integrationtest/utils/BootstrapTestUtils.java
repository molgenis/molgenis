...
public class BootstrapTestUtils {
  ...
  @Autowired private SettingsPopulator settingsPopulator;
  ...
  // TODO Synchronise integration test bootstrapper with production bootstrapper (see
  // https://github.com/molgenis/molgenis/issues/5934)
