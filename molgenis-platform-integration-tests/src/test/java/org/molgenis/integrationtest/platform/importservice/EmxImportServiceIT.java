...
//
// class EmxImportServiceIT extends ImportServiceIT {
...
//  @Test
//  void testDoImportEmxCsvZipAsNonSuperuser() {
...
//      roles = {ROLE_SU})
//  @Test
//  void testDoImportEmxCsvZipAsSuperuser() {
//    testDoImportEmxCsvZip();
//  }
//
...
//  @WithMockUser(username = USERNAME)
//  @Test
//  void testDoImportEmxTsvZipAsNonSuperuser() {
//    populateUserPermissions();
...
//      roles = {ROLE_SU})
//  @Test
//  void testDoImportEmxTsvZipAsSuperuser() {
//    testDoImportEmxTsvZip();
//  }
//
...
//  }
//
//  static Iterator<Object[]> doImportEmxAddProvider() {
...
//  }
//
//  private static void verifyItEmxDataTypes() {
//    verifyFirstAndLastRows("it_emx_datatypes_TypeTest", typeTestFirstRow, typeTestLastRow);
//    verifyFirstAndLastRows("it_emx_datatypes_TypeTestRef", typeTestRefFirstRow,
// typeTestRefLastRow);
//  }
//
...
//
//  @ParameterizedTest
//  @MethodSource("doImportEmxAddProvider")
//  @WithMockUser(username = USERNAME)
//  void testDoImportAddEmxAsNonSuperuser(
//      File file,
...
//      username = USERNAME,
//      roles = {ROLE_SU})
//  void testDoImportAddEmxAsSuperuser(
//      File file,
//      Map<String, Integer> entityCountMap,
//      Set<String> addedEntityTypes,
//      Runnable entityValidationMethod) {
...
//  }
//
//  static Iterator<Object[]> doImportEmxAddUpdateProvider() {
//    List<Object[]> data = new ArrayList<>();
//
//    data.add(
//        createUpdateData(
...
//
//    Set<Map<String, Object>> importedEntityValuesSet =
//        importedEntities.stream().map(ImportServiceIT::entityToMap).collect(Collectors.toSet());
//
//    List<Map<String, Object>> someExpectedEntityValues =
//        asList(testAddUpdateFirstRow, testAddUpdateSecondRow, testAddUpdateLastRow);
...
//
//  @ParameterizedTest
//  @MethodSource("doImportEmxAddUpdateProvider")
//  @WithMockUser(username = USERNAME)
//  void testDoImportAddUpdateEmxAsNonSuperuser(
//      File file,
//      File addUpdateFile,
//      Map<String, Integer> entityCountMap,
//      Set<String> addedEntityTypes,
...
//      username = USERNAME,
//      roles = {ROLE_SU})
//  void testDoImportAddUpdateEmxAsSuperuser(
//      File file,
//      File addUpdateFile,
//      Map<String, Integer> entityCountMap,
//      Set<String> addedEntityTypes,
...
//        fileRepositoryCollectionFactory.createFileRepositoryCollection(file);
//    ImportService addImportService = importServiceFactory.getImportService(file,
// addRepoCollection);
...
//            addUpdateRepoCollection, MetadataAction.UPSERT, ADD_UPDATE_EXISTING, null);
//
//    validateImportReport(importReport, entityCountMap, addedEntityTypes);
//    entityValidationMethod.run();
//  }
//
//  static Iterator<Object[]> doImportEmxUpdateProvider() {
//    List<Object[]> data = new ArrayList<>();
//
//    data.add(
//        createUpdateData(
...
//    data.add(
//        createUpdateData(
//            "it_emx_requiredDefaultValue.xlsx",
//            "it_emx_requiredDefaultValue-update.xlsx",
//            asList("it", "emx", "default"),
//            emptyMap(),
//            Collections.emptySet(),
...
//
//  @ParameterizedTest
//  @MethodSource("doImportEmxUpdateProvider")
//  @WithMockUser(username = USERNAME)
//  void testDoImportUpdateEmxAsNonSuperuser(
//      File file,
//      File updateFile,
//      Map<String, Integer> entityCountMap,
//      Set<String> addedEntityTypes,
...
//      username = USERNAME,
//      roles = {ROLE_SU})
//  void testDoImportUpdateEmxAsSuperuser(
//      File file,
//      File updateFile,
//      Map<String, Integer> entityCountMap,
//      Set<String> addedEntityTypes,
...
//            .collect(toSet());
//    return new Object[] {
//      addFile, updateFile, entityTypeCountMap, entityTypeFullyQualifiedNames,
...
//    // users cannot create entities and packages without a parent package, therefor the root
// package
...
//    permissionMap.put(new EntityTypeIdentity("sys_dec_DecoratorConfiguration"),
// PermissionSet.READ);
