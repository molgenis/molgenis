...
class ExceptionHandlerUtils {
  ...
  static Object handleException(
      Exception e, HandlerMethod handlerMethod, HttpStatus httpStatus, String errorCode) {
  ...
  static Object handleException(
    ...
    return handleException(
        e, isHtmlRequest(httpServletRequest), httpStatus, errorCode, environment);
  }

  static Object handleException(
      Exception e, HttpServletRequest httpServletRequest, HttpStatus httpStatus, String errorCode) {
    return handleException(e, isHtmlRequest(httpServletRequest), httpStatus, errorCode, PRODUCTION);
  }

  private static Object handleException(
      Exception e,
  ...
  private static ErrorMessageResponse createErrorMessageResponse(Exception e, String errorCode) {
    if (e instanceof Errors) {
      ...
      return new ErrorMessageResponse(
          new ErrorMessageResponse.ErrorMessage(e.getLocalizedMessage(), errorCode));
    }
  }
  ...
  private static boolean isHtmlRequest(HandlerMethod handlerMethod) {
    return !(handlerMethod.hasMethodAnnotation(ResponseBody.class)
        || handlerMethod.hasMethodAnnotation(ResponseStatus.class)
