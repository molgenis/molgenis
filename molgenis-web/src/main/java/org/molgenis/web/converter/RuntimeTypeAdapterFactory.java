...
public final class RuntimeTypeAdapterFactory<T> implements TypeAdapterFactory {
  ...
  public RuntimeTypeAdapterFactory<T> registerAutoValueSubtype(
      Class<? extends T> clazz, String label) {
    AutoGson annotation = clazz.getAnnotation(AutoGson.class);
    if (annotation == null) {
      throw new IllegalArgumentException("Auto value type must have AutoGson annotation");
    }
    return registerSubtype(annotation.autoValueClass(), label);
  }
