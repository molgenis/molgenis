...
public class SpringExceptionHandlerTest extends AbstractMockitoTest {
  ...
  @Mock private HttpMediaTypeNotAcceptableException httpMediaTypeNotAcceptableException;
  @Mock private HttpMessageNotWritableException httpMessageNotWritableException;
  @Mock private HttpMessageNotReadableException httpMessageNotReadableException;
  @Mock private TypeMismatchException typeMismatchException;
  @Mock private HttpMediaTypeNotSupportedException httpMediaTypeNotSupportedException;
  @Mock private ServletRequestBindingException servletRequestBindingException;
  ...
  public void beforeClass() {
    ...
    fieldError =
        new FieldError(
            ...
            -10,
            false,
            new String[] {"Min.entityCollectionRequestV2.num", "Min.num", "Min.int", "Min"},
            new Object[] {
              new DefaultMessageSourceResolvable(
                  new String[] {"entityCollectionRequestV2.num", "num"}, null, "num"),
              0
            },
  ...
  public void AsyncRequestTimeoutException() {
    ...
    assertEquals(
        handler.handleSpringException(asyncRequestTimeoutException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            SERVICE_UNAVAILABLE));
  }
  ...
  public void testBindException() {
    ...
    assertEquals(
        handler.handleSpringException(bindException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(
                ImmutableList.of(
                    new ErrorMessageResponse.ErrorMessage(
                        "'entityCollectionRequestV2' must have two fields set", "TwoFieldsSet"),
                    new ErrorMessageResponse.ErrorMessage(
  ...
  public void testMissingServletRequestPartException() {
    ...
    assertEquals(
        handler.handleSpringException(missingServletRequestPartException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            BAD_REQUEST));
  }
  ...
  public void testMethodArgumentNotValidException() {
    ...
    assertEquals(
        handler.handleSpringException(methodArgumentNotValidException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(
                ImmutableList.of(
                    new ErrorMessageResponse.ErrorMessage(
  ...
  public void testHttpMessageNotWritableException() {
    ...
    assertEquals(
        handler.handleSpringException(httpMessageNotWritableException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
  ...
  public void testHttpMessageNotReadableException() {
    ...
    assertEquals(
        handler.handleSpringException(httpMessageNotReadableException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            BAD_REQUEST));
  }
  ...
  public void testTypeMismatchException() {
    ...
    assertEquals(
        handler.handleSpringException(typeMismatchException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            BAD_REQUEST));
  }
  ...
  public void testConversionNotSupportedException() {
    ...
    assertEquals(
        handler.handleSpringException(conversionNotSupportedException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            INTERNAL_SERVER_ERROR));
  }
  ...
  public void testServletRequestBindingException() {
    ...
    assertEquals(
        handler.handleSpringException(servletRequestBindingException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            BAD_REQUEST));
  }
  ...
  public void testMissingServletRequestParameterExceptionn() {
    when(handlerMethod.hasMethodAnnotation(ResponseBody.class)).thenReturn(true);
    when(missingServletRequestParameterException.getLocalizedMessage())
        .thenReturn("localized message");

    assertEquals(
        handler.handleSpringException(missingServletRequestParameterException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            BAD_REQUEST));
  }
  ...
  public void testMissingPathVariableException() {
    ...
    assertEquals(
        handler.handleSpringException(missingPathVariableException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            INTERNAL_SERVER_ERROR));
  }
  ...
  public void testHttpMediaTypeNotAcceptableException() {
    ...
    assertEquals(
        handler.handleSpringException(httpMediaTypeNotAcceptableException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
            NOT_ACCEPTABLE));
  }
  ...
  public void testHttpMediaTypeNotSupportedException() {
    ...
    assertEquals(
        handler.handleSpringException(httpMediaTypeNotSupportedException, handlerMethod),
        new ResponseEntity<>(
            new ErrorMessageResponse(new ErrorMessageResponse.ErrorMessage("localized message")),
