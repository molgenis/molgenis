...
public class LocalizationPopulatorTest extends AbstractMockitoTest {
  ...
  @Mock private L10nString enOnly;
  @Mock private L10nString nlOnly;
  @Mock private L10nString biobankUTF8;
  @Captor private ArgumentCaptor<Collection<L10nString>> updateCaptor;
  @Captor private ArgumentCaptor<Collection<L10nString>> addCaptor;
  ...
  public void testPopulate() {
    ...
    when(localizationService.getExistingMessages(
            "test", ImmutableSet.of("EN_PLUS_NL", "EN_ONLY", "NL_ONLY", "BIOBANK_UTF8")))
