...
public interface ChartDataService
{
	...
	List<BoxPlotSerie> getBoxPlotSeries(String entityName, String attributeName, List<QueryRule> queryRules,
			String split);

	BoxPlotSerie getBoxPlotSerie(String entityName, String attributeName, List<QueryRule> queryRules);
}
