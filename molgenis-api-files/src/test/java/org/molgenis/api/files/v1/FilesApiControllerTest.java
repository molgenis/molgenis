...
public class FilesApiControllerTest extends AbstractMockitoTest {
  @Mock private FilesApiService filesApiService;
  private FilesApiController filesApiController;

  @BeforeMethod
  public void setUpBeforeMethod() {
    filesApiController = new FilesApiController(filesApiService);
  }

  @Test(expectedExceptions = NullPointerException.class)
  public void testFilesApiController() {
    new FilesApiController(null);
  }
