...
class FileUploadServiceImpl implements FileUploadService {
  ...
  @Override
  public FileMeta getFileMeta(String fileMetaId) {
    FileMeta fileMeta = dataService.findOneById(FILE_META, fileMetaId, FileMeta.class);
    if (fileMeta == null) {
      throw new UnknownEntityException(FILE_META, fileMetaId);
    }
    return fileMeta;
  }
