...
public class RestControllerV2Test extends AbstractMolgenisSpringTest {
  ...
  public void retrieveResourceCollectionUnknownEntityType() throws Exception {
    ...
    mockMvc
        .perform(get(BASE_URI + '/' + unknownEntityTypeId))
  ...
  public void testCreateEntities() throws Exception {
    mockMvc
        ...
        .andExpect(content().contentType(APPLICATION_JSON_UTF8))
        .andExpect(jsonPath("$.location", is("/v2/entity?q=id=in=(\"p1\",\"p2\")")))
        .andExpect(jsonPath("$.resources", hasSize(2)))
        .andExpect(jsonPath("$.resources[0].href", is("/v2/entity/p1")))
        .andExpect(jsonPath("$.resources[1].href", is("/v2/entity/p2")));
  ...
  public void testCreateEntitiesAttribute() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(status().isCreated())
        .andExpect(content().contentType(APPLICATION_JSON_UTF8))
        .andExpect(jsonPath("$.location", is("/v2/sys_md_Attribute?q=id=in=(\"p1\",\"p2\")")))
        .andExpect(jsonPath("$.resources", hasSize(2)))
        .andExpect(jsonPath("$.resources[0].href", is("/v2/sys_md_Attribute/p1")))
        .andExpect(jsonPath("$.resources[1].href", is("/v2/sys_md_Attribute/p2")));
  ...
  public void testCopyEntity() throws Exception {
    ...
    mockMvc
        ...
        .andExpect(header().string("Location", "/v2/org_molgenis_blah_newEntity"));
  ...
  public void testCreateEntitiesNoneProvided() throws Exception {
    mockMvc
        .perform(post(BASE_URI + "/" + "entity").content("{data:[]}").contentType(APPLICATION_JSON))
        .andExpect(status().isBadRequest())
        .andExpect(
            jsonPath(
                FIRST_ERROR_MESSAGE,
    ...
    mockMvc
        .perform(
            post(BASE_URI + "/" + "entity")
                ...
                .contentType(APPLICATION_JSON))
        .andExpect(status().isBadRequest())
        .andExpect(jsonPath(FIRST_ERROR_MESSAGE, is("Number of data cannot be more than 1000.")));
  }
  ...
  public void testUpdateEntities() throws Exception {
    String content = "{data:[{id:'p1', name:'Witte Piet'}, {id:'p2', name:'Zwarte Piet'}]}";
    mockMvc
  ...
  public void testUpdateEntitiesNoEntities() throws Exception {
    mockMvc
        .perform(put(BASE_URI + "/" + "entity").content("{entities:[]}").contentType(APPLICATION_JSON))
        .andExpect(status().isBadRequest())
        .andExpect(
            jsonPath(
                FIRST_ERROR_MESSAGE,
  ...
  public void testDeleteEntityCollectionExceptionNoEntitiesToDelete() throws Exception {
    mockMvc
        .perform(
            delete("/v2/MyEntityType").contentType(APPLICATION_JSON).content("{\"entityIds\":[]}"))
        .andExpect(status().isBadRequest())
        .andExpect(
            jsonPath(
                FIRST_ERROR_MESSAGE,
  ...
  public void testDeleteEntityCollectionExceptionInvalidRequestBody() throws Exception {
    this.mockMvc
        .perform(delete("/v2/MyEntityType").contentType(APPLICATION_JSON).content("invalid"))
        .andExpect(status().isBadRequest())
  ...
  public void testSelfRefWithAllAttrsEqualsSelfRefWithoutAttrs() throws Exception {
    String withAttrs =
        mockMvc
            ...
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.selfRef._href", is("/v2/selfRefEntity/0")))
    ...
    mockMvc
        .perform(
            get(BASE_URI + "/selfRefEntity/0?attrs=*,selfRef(*,selfRef(*))")
                .contentType(APPLICATION_JSON))
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.selfRef.selfRef._href", is("/v2/selfRefEntity/0")))
        .andExpect(jsonPath("$.selfRef.selfRef.id", is("0")))
        .andExpect(jsonPath("$.selfRef.selfRef.selfRef._href", is("/v2/selfRefEntity/0")))
