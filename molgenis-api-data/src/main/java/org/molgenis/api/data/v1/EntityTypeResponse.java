...
public class EntityTypeResponse {
  ...
  public EntityTypeResponse(
    ...
    this.href = UriUtils.createEntityTypeMetadataUriPath(metaId);
    this.hrefCollection = UriUtils.createEntityCollectionUriPath(metaId);
      ...
      for (Attribute attr : Lists.newArrayList(meta.getAttributes())) {
        if (!attr.getName().equals("__Type")) {
          if (attributeExpandsSet != null
            ...
            String attrHref =
                UriUtils.createEntityTypeMetadataAttributeUriPath(metaId, attr.getName());
