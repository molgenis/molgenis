...
public class RestController {
  ...
  static final String BASE_URI = "/" + API_VERSION;
  ...
  private void createInternal(
    ...
    if (id != null) {
      response.addHeader("Location", UriUtils.createEntityUriPath(entityTypeId, id));
    }
    ...
    switch (attr.getDataType()) {
      ...
      case ONE_TO_MANY:
        ...
        return new EntityCollectionResponse(
            pager, refEntityMaps, attrHref, null, permissionService, dataService);
      case CATEGORICAL:
      case XREF:
  ...
  private Map<String, Object> getEntityAsMap(
    ...
    entityMap.put("href", UriUtils.createEntityUriPath(meta.getId(), entity.getIdValue()));
      ...
      if (attrType == COMPOUND) {
        if (attributeExpandsSet != null
          ...
          entityMap.put(
              ...
              Collections.singletonMap(
                  "href",
                  UriUtils.createEntityAttributeUriPath(
                      meta.getId(), entity.getIdValue(), attrName)));
        }
        ...
        EntityCollectionResponse ecr =
            new EntityCollectionResponse(
                pager,
                refEntityMaps,
                UriUtils.createEntityAttributeUriPath(meta.getId(), entity.getIdValue(), attrName),
                null,
                permissionService,
                dataService);
