...
public class AttributeFilterToFetchConverter {
  ...
  /**
   * Create default fetch for the given attribute. For attributes referencing entities the id and label
   * value are fetched. Additionally for file entities the URL is fetched. For other attributes the
   * default fetch is null;
   *
