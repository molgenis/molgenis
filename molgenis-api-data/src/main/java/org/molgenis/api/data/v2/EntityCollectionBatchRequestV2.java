...
public abstract class EntityCollectionBatchRequestV2 {
  ...
  @NotEmpty(message = "Please provide at least one entity in the data property.")
  @Size(max = RestControllerV2.MAX_ENTITIES, message = "Number of data cannot be more than {max}.")
