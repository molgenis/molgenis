 ...
 * always be fetched.
 *
 * <p>Referenced entities will always be fetched using ID and label, but you can also specify a list of
 * attribute names. Those will be added to the ID and label attributes, which will always be
