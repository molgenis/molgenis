...
public class DatasetRangeHandlingDataSource extends RangeHandlingDataSource implements RangeHandlingAnnotationDataSource
{
    ...
    {
        return dataService.findOne(DataSet.ENTITY_NAME, new QueryImpl().eq(DataSet.IDENTIFIER, dataSet));
    }
                                                         ...
                                                         DataSet dataSet)
    {
        ...
        observationSets = dataService.findAll(ObservationSet.ENTITY_NAME, variantQuery);
