...
/**
 * Workaround to replace molgenis-data-rest dependency on molgenis-core-ui with molgenis-data-file.
 * Remove once file upload/download has its own API and REST API only deal with file metadata
 * references.
 *
