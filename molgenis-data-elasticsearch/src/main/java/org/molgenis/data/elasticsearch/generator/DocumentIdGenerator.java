...
public class DocumentIdGenerator extends AbstractMetadataIdGenerator {
  /**
   * Unknown whether Elasticsearch document type names or field names have a length limit. Limit
   * length to be on the safe side.
   */
  private static final int MAX_IDENTIFIER_LENGTH = 32;

  /**
   * Document types cannot start with '_' and cannot contain '#', ',' and '.'. Stick to alphanumeric
