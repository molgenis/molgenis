...
public class MappingsBuilder
{
	...
	public static void buildMapping(XContentBuilder jsonBuilder, EntityType entityType,
			DocumentIdGenerator documentIdGenerator, boolean enableNorms, boolean createAllIndex) throws IOException
	{
	...
	private static void createAttributeMapping(Attribute attr, DocumentIdGenerator documentIdGenerator,
			boolean enableNorms, boolean createAllIndex, boolean nestRefs, boolean enableNgramAnalyzer,
			...
			case XREF:
				...
				else
				{
					createAttributeMappingContents(refEntity.getLabelAttribute(), documentIdGenerator, enableNorms,
							createAllIndex, false, enableNgramAnalyzer, jsonBuilder);
				}
				break;
			case COMPOUND:
