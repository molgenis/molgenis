...
public class SortContentBuilderTest {
  ...
  public void createSortsAsc() {
    List<SortBuilder> sorts =
        sortContentBuilder.createSorts(Sort.create(singletonList(SortOrder.create("field", ASC))));
  ...
  public void createSortsDesc() {
    List<SortBuilder> sorts =
        sortContentBuilder.createSorts(Sort.create(singletonList(SortOrder.create("field", DESC))));
