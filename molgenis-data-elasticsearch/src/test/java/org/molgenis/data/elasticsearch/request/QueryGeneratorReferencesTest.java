...
public class QueryGeneratorReferencesTest extends AbstractMolgenisSpringTest
{
	...
	public void setUp()
	{
		...
		EntityType refEntityType = null; //FIXME entityTypeFactory.create().setFullyQualifiedName("ref_entity");
		...
		EntityType emd = null;//FIXME entityTypeFactory.create().setFullyQualifiedName("entity");
