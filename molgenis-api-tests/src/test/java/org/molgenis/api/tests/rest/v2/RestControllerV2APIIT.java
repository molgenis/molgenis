...
public class RestControllerV2APIIT {
  ...
  public void testDeleteEntity() {
    ...
    given()
        ...
        .body(
            ...
            Matchers.equalTo(4),
            "items[0].value",
            Matchers.equalTo("ref2"),
            "items[1].value",
            Matchers.equalTo("ref3"),
            "items[2].value",
            Matchers.equalTo("ref4"),
            "items[3].value",
  ...
  public void testCreateEntities() {
    ...
    given()
        ...
        .body(
            "location",
            Matchers.equalTo("/api/v2/V2_API_TypeTestv2?q=id=in=(\"55\",\"57\")"),
            "resources[0].href",
            Matchers.equalTo("/api/v2/V2_API_TypeTestAPIV2/55"),
            "resources[1].href",
  ...
  private void validateRetrieveEntityCollection(ValidatableResponse response) {
    ...
    response.body(
        ...
        Matchers.equalTo("label1"),
        "items[1]._href",
        Matchers.equalTo("/api/v2/V2_API_TypeTestRefAPIV2/ref2"),
        "items[1].value",
        Matchers.equalTo("ref2"),
        "items[1].label",
        Matchers.equalTo("label2"),
        "items[2]._href",
        Matchers.equalTo("/api/v2/V2_API_TypeTestRefAPIV2/ref3"),
        "items[2].value",
        Matchers.equalTo("ref3"),
        "items[2].label",
        Matchers.equalTo("label3"),
        "items[3]._href",
        Matchers.equalTo("/api/v2/V2_API_TypeTestRefAPIV2/ref4"),
        "items[3].value",
        Matchers.equalTo("ref4"),
        "items[3].label",
        Matchers.equalTo("label4"),
        "items[4]._href",
        Matchers.equalTo("/api/v2/V2_API_TypeTestRefAPIV2/ref5"),
        "items[4].value",
        Matchers.equalTo("ref5"),
        "items[4].label",
        Matchers.equalTo("label5"));
  }
