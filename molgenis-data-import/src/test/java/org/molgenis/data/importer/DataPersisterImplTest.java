...
public class DataPersisterImplTest extends AbstractMockitoTest {
  ...
  public void setUpBeforeMethod() {
    ...
    when(dataProvider.getEntityTypes())
    ...
    when(entityTypeDependencyResolver.resolve(asList(entityType0, entityType1, entityType2)))
  ...
  public void testPersistMetaUpdateDataAdd() {
    ...
    when(dataService.findOneById(ENTITY_TYPE_META_DATA, entityType0.getId(), EntityType.class))
        .thenReturn(existingEntityType0);
    when(dataService.findOneById(ENTITY_TYPE_META_DATA, entityType1.getId(), EntityType.class))
