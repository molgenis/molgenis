        ...
        $('#entity-class-group-permission-form').submit(function(e) {
            ...
            $.ajax({
                ...
                error: function (xhr, textStatus, errorThrown) {
                    ...
                    $('#plugin-container .alert').remove();
                    $('#plugin-container').prepend('<div class="alert alert-danger"><button type="button" class="close" data-dismiss="alert">&times;</button><strong>Error!</strong><span id="molgenis-alert"> ' + errorMessage + '</span></div>');
                }
            });
        });
