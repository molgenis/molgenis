	...
	private void parseAttributesSheet(Repository<Entity> attributesRepo, IntermediateParseResults intermediateResults)
	{
		...
		for (Entity attributeEntity : attributesRepo)
		{
			...
			if (attributeName == null)
				throw new MissingMetadataValueException("name", attributeName, "attributes", rowIndex);
		...
		for (Entity emxAttrEntity : attributesRepo)
		{
			...
			if (emxDataType != null)
			{
				...
				if (type == null)
				{
					throw new UnknownAttributeTypeException(emxDataType, attr, rowIndex);
				}
			...
			if (refEntityName != null)
			{
				if (dataService != null)
				{
					...
					if (mappedByAttrName != null)
					{
						...
						{
							throw new UnknownMappedByException(attribute, mappedByAttrName, rowIndex);
						}
