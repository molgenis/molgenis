...
public class RowLevelSecurityUtils
{
	...
	public static boolean hasPermission(Entity entity, Permission permission)
	{
		if (currentUserIsSu()) return true;
		String usernamesStr = RunAsSystemProxy.runAsSystem(() -> entity.getString("_" + permission.toString()));
