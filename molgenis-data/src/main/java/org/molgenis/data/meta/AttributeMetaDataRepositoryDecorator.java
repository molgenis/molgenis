...
public class AttributeMetaDataRepositoryDecorator implements Repository<AttributeMetaData>
{
	...
	static
	{
		...
		DATA_TYPE_ALLOWED_TRANSITIONS.put(DECIMAL, EnumSet.of(CATEGORICAL, HTML, INT, LONG, SCRIPT, TEXT, XREF));
		...
		DATA_TYPE_ALLOWED_TRANSITIONS.put(INT, EnumSet.of(CATEGORICAL, DECIMAL, HTML, LONG, SCRIPT, TEXT, XREF));
		DATA_TYPE_ALLOWED_TRANSITIONS.put(LONG, EnumSet.of(CATEGORICAL, DECIMAL, HTML, INT, SCRIPT, TEXT, XREF));
