...
/**
 * Helper class around the {@link PackageMetaData} repository. Caches the package metadata in {@link Package}s.
...
class PackageRepository
{
	 ...
	 */
	private Map<String, Package> packageCache = new HashMap<>();
...
//		}
//
//		Package pImpl = new Package(p.getSimpleName(), p.getDescription(), parent);
//		if (parent != null)
//		{
...
//		return packageCache.get(fullyQualifiedName).toEntity();
	 ...
	 */
	public static Map<String, Package> createPackageTree(Iterable<Entity> packageEntities)
	{
...
//		{
//			Package p = new Package(entity.getString(SIMPLE_NAME),
...
//		{
//			Package p = result.get(e.get(PackageMetaData.FULL_NAME));
//			if (e.get(PackageMetaData.PARENT) != null)
//			{
//				Package parent = result.get(e.getEntity(PackageMetaData.PARENT)
