...
import static org.molgenis.data.meta.EntityMetaDataMetaData.INSTANCE;
 ...
 */
public class EntityMetaData extends AbstractEntity
{
	...
	{
		Entity entityCopy = MapEntity.newInstance(entityMeta.entity);
