...
public class EntityTypeMetadata extends SystemEntityType {
  ...
  /**
   * Used during bootstrapping to set the enum options for the backend field. Circumvents
   * unresolvable circular dependencies when autowiring RepositoryCollectionRegistry into this bean.
   *
