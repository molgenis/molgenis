...
public class EntityStream implements Stream<Entity> {
  ...
  @Override
  public <U> U reduce(
      U identity, BiFunction<U, ? super Entity, U> accumulator, BinaryOperator<U> combiner) {
    return stream.reduce(identity, accumulator, combiner);
  }

  @Override
  public <R> R collect(
      Supplier<R> supplier, BiConsumer<R, ? super Entity> accumulator, BiConsumer<R, R> combiner) {
