...
public interface IdGenerator {
   ...
   * <li>{@link #SEQUENTIAL_UUID}
   * <li>{@link #SECURE_RANDOM}
   * <li>{@link #SHORT_RANDOM}
   * <li>{@link #SHORT_SECURE_RANDOM}
   */
  enum Strategy {
    /**
     * Globally unique sequential UUIDs. 26 characters long, base32 encoded. The IDs are based on
     * the current epoch time, current machine identity, and a counter. The result are mostly
     * ordered unique ids that require no synchronization between machines.
     */
    SEQUENTIAL_UUID,
