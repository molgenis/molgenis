...
//
//		MapEntity entity1 = new MapEntity(ImmutableMap
//				.of(AttributeMetaDataMetaData.NAME, "height_0", AttributeMetaDataMetaData.LABEL, "height",
...
//
//		Iterable<AttributeMetaData> actual = MetaUtils
//				.toExistingAttributeMetaData(entityMetaData, attributeMetaDataEntities);
...
//
//		MapEntity entity1 = new MapEntity(ImmutableMap
//				.of(AttributeMetaDataMetaData.NAME, "height_wrong_name", AttributeMetaDataMetaData.LABEL, "height",
//						AttributeMetaDataMetaData.DESCRIPTION, "this is a height measurement in m!"));
//		Iterable<Entity> attributeMetaDataEntities = Arrays.<Entity>asList(entity1);
