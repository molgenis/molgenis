...
public class OneToManyTestHarness {
  @Autowired AuthorFactory1 authorFactory1;
  @Autowired AuthorFactory2 authorFactory2;
  @Autowired AuthorFactory3 authorFactory3;
  @Autowired AuthorFactory4 authorFactory4;
  @Autowired AuthorMetaData1 authorMetaData1;
  @Autowired AuthorMetaData2 authorMetaData2;
  @Autowired AuthorMetaData3 authorMetaData3;
  @Autowired AuthorMetaData4 authorMetaData4;
  @Autowired BookFactory1 bookFactory1;
  @Autowired BookFactory2 bookFactory2;
  @Autowired BookFactory3 bookFactory3;
  @Autowired BookFactory4 bookFactory4;
  @Autowired BookMetaData1 bookMetaData1;
  @Autowired BookMetaData2 bookMetaData2;
  @Autowired BookMetaData3 bookMetaData3;
  @Autowired BookMetaData4 bookMetaData4;

  @Autowired PersonFactory1 personFactory1;
  @Autowired PersonFactory2 personFactory2;
  @Autowired PersonFactory3 personFactory3;
  @Autowired PersonFactory4 personFactory4;
  @Autowired PersonMetaData1 personMetaData1;
  @Autowired PersonMetaData2 personMetaData2;
  @Autowired PersonMetaData3 personMetaData3;
  @Autowired PersonMetaData4 personMetaData4;
  ...
  /**
   * Creates Author and Book entity test sets for a specific use case. Entities are always linked as
   * follows (when imported): author1 -> book1, author2 -> book2, author3 -> book3, and vice versa.
   *
   * <p>Case 1: Book.author = nullable | no ordering Case 2: Book.author = required | no ordering
   * Case 3: Book.author = nullable | ascending order Case 4: Book.author = nullable | descending
   * order
   */
  public AuthorsAndBooks createAuthorAndBookEntities(TestCaseType testCase) {
    switch (testCase) {
      case XREF_NULLABLE:
        return createTestEntitiesSetBooksField(
            authorFactory1, bookFactory1, authorMetaData1, bookMetaData1);
      case XREF_REQUIRED:
        return createTestEntitiesSetBooksField(
            authorFactory2, bookFactory2, authorMetaData2, bookMetaData2);
      case ASCENDING_ORDER:
        return createTestEntitiesSetBooksField(
            authorFactory3, bookFactory3, authorMetaData3, bookMetaData3);
      case DESCENDING_ORDER:
        return createTestEntitiesSetBooksField(
            authorFactory4, bookFactory4, authorMetaData4, bookMetaData4);
      default:
  ...
  /**
   * Creates Person entity test sets for a specific use case. Entities are always linked as follows
   * (when imported): person1 -> person2, person2 -> person3, person3 -> person1
   *
   * <p>Case 1: Person.children = nullable | no ordering Case 2: Person.children = required | no
   * ordering Case 3: Person.children = nullable | ascending order Case 4: Person.children =
   * nullable | descending order
   */
  ...
  public static class AuthorsAndBooks {
    ...
    AuthorsAndBooks(
        @Nonnull List<Entity> authors,
        @Nonnull List<Entity> books,
        @Nonnull EntityType authorMetaData,
