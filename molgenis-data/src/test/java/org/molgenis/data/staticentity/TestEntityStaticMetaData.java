...
public class TestEntityStaticMetaData extends SystemEntityType {
  ...
  public TestEntityStaticMetaData(
      TestPackage testPackage, TestRefEntityStaticMetaData testRefEntityStaticMetaData) {
  ...
  public void init() {
    ...
    addAttribute(EntityTestHarness.ATTR_BOOL)
        .setDataType(BOOL)
        .setAggregatable(true)
        .setNillable(false)
        .setDefaultValue(valueOf(true));
    addAttribute(EntityTestHarness.ATTR_CATEGORICAL)
        .setDataType(CATEGORICAL)
        .setRefEntity(testRefEntityStaticMetaData);
    addAttribute(EntityTestHarness.ATTR_CATEGORICAL_MREF)
        .setDataType(CATEGORICAL_MREF)
        .setRefEntity(testRefEntityStaticMetaData);
    addAttribute(EntityTestHarness.ATTR_ENUM)
        .setDataType(ENUM)
    ...
    addAttribute(EntityTestHarness.ATTR_INT)
        .setDataType(INT)
        .setAggregatable(true)
        .setNillable(false)
        .setDefaultValue(valueOf(1));
    addAttribute(EntityTestHarness.ATTR_SCRIPT).setDataType(SCRIPT);
    addAttribute(EntityTestHarness.ATTR_XREF)
        .setDataType(XREF)
        .setRefEntity(testRefEntityStaticMetaData);
    addAttribute(EntityTestHarness.ATTR_MREF)
        .setDataType(MREF)
        .setRefEntity(testRefEntityStaticMetaData);
