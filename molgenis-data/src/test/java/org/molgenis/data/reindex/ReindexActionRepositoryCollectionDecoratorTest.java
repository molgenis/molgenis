...
public class ReindexActionRepositoryCollectionDecoratorTest
{
	...
	public void deleteEntityMeta()
	{
		...
		verify(reindexActionRegisterService).register("repo", CudType.DELETE, DataType.METADATA, null);
	}
	...
	public void addAttribute()
	{
		...
		verify(reindexActionRegisterService).register("repo", CudType.UPDATE, DataType.METADATA, null);
	}
	...
	public void addEntityMeta()
	{
		...
		verify(reindexActionRegisterService).register("repo", CudType.CREATE, DataType.METADATA, null);
	}
}
