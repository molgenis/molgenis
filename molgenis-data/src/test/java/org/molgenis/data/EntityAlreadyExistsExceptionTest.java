...
public class EntityAlreadyExistsExceptionTest extends ExceptionMessageTest
{
	...
	public void testGetLocalizedMessage(String lang, String message)
	{
		...
		EntityType entityType = when(mock(EntityType.class).getLabel(lang)).thenReturn("My Entity Type").getMock();
	...
	{
		return new Object[][] { new Object[] { "en", "Entity 'id0' of type 'My Entity Type' already exists." },
