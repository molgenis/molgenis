...
public class AppMetaData extends SystemEntityType {
    ...
    protected void init() {
        ...
        addAttribute(USE_FREEMARKER_TEMPLATE).setDataType(BOOL).setLabel("Use freemarker template as index.html")
                .setNillable(false).setDefaultValue(Boolean.FALSE.toString())
                .setDescription("When using a freemarker template, the index page of your app should be placed in "+
