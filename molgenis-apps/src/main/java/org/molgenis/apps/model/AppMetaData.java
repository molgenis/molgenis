		...
		addAttribute(USE_FREEMARKER_TEMPLATE).setDataType(BOOL)
											 ...
											 .setDescription(
													 "When using a freemarker template, the index page of your app should be placed in "
															 ...
															 + "When selecting no, please include an index.html in the root of your app.zip");addAttribute(LANDING_PAGE_HTML_TEMPLATE).setDataType(XREF).setRefEntity(freemarkerTemplateMetaData)
				.setNillable(true).setLabel("Landing page HTML template").setVisibleExpression(
