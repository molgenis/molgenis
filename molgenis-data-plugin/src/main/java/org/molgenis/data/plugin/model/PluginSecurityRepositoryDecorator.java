...
/**
 * {@link Plugin} decorator that creates/deletes {@link org.springframework.security.acls.model.Acl
 * ACLs} when creating/deleting plugins.
 */
public class PluginSecurityRepositoryDecorator extends AbstractRepositoryDecorator<Plugin> {
  ...
  PluginSecurityRepositoryDecorator(
      Repository<Plugin> delegateRepository, MutableAclService mutableAclService) {
