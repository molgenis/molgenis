...
public class BeaconMetadata extends SystemEntityType {
  ...
  public BeaconMetadata(
      BeaconPackage beaconPackage,
      BeaconOrganizationMetadata beaconOrganizationMetadata,
  ...
  protected void init() {
    ...
    setDescription(
        "A Beacon based on ga4gh beacon API. See https://github.com/ga4gh for more information");
