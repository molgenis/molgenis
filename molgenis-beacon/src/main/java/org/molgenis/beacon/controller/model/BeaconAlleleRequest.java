...
public abstract class BeaconAlleleRequest {
   ...
   *
   * <p>Accepted values: non-negative integers smaller than reference length.
   */
   ...
   *
   * <p>Accepted values: see the REF field in VCF 4.2 specification
   ...
   *
   * <p>Accepted values: see the ALT field in VCF 4.2 specification
   * (https://samtools.github.io/hts-specs/VCFv4.2.pdf).
   */
  public abstract String getAlternateBases();

  public static BeaconAlleleRequest create(
      String referenceName, Long start, String referenceBases, String alternateBases) {
