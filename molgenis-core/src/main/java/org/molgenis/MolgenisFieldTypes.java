...
import org.molgenis.fieldtypes.HasField;
...
public class MolgenisFieldTypes
{
	...
	{
		BOOL, CATEGORICAL, DATE, DATE_TIME, DECIMAL, EMAIL, ENUM, FILE, HTML, HYPERLINK, IMAGE, INT, LONG, MREF, STRING, TEXT, XREF, HAS
	}
