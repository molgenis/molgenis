...
<html>
	<head>
		...
		<link rel="stylesheet" href="css/molgenis-dateinput.css" type="text/css">
		<link rel="stylesheet" href="css/molgenis-xrefinput.css" type="text/css">		
		<link rel="stylesheet" href="css/molgenis-menu.css" type="text/css">
		<link rel="stylesheet" href="css/molgenis-jquery_icons.css" type="text/css">
		<script type="text/javascript" src="js/jquery-1.8.3.min.js"></script>
  		<script type="text/javascript" src="js/jquery-ui-1.9.2.custom.min.js"></script>
		<script type="text/javascript" src="js/bootstrap.min.js"></script>
		<script type="text/javascript" src="js/molgenis-all.js"></script>	
		<script type="text/javascript" src="js/molgenis-popup.js"></script>	
		<script type="text/javascript" src="js/molgenis-textinput.js"></script>		
		<script type="text/javascript" src="js/molgenis-datetimeinput.js"></script>
		<script type="text/javascript" src="js/molgenis-xrefinput.js"></script>
		<script type="text/javascript" src="js/molgenis-mrefinput.js"></script>					
		<script type="text/javascript" src="js/molgenis-menu.js"></script>
		<script type="text/javascript" src="js/molgenis-rest.js"></script>	
		<script type="text/javascript" src="js/molgenis-recoverscroll.js"></script>	
