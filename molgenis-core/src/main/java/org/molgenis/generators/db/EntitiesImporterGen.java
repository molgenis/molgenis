...
{
	private static final Logger logger = Logger.getLogger(EntitiesImporterGen.class);
	...
	public void generate(Model model, MolgenisOptions options) throws Exception
	{
		...
		File target = new File(this.getSourcePath(options) + APP_DIR + "/EntitiesImporterImpl.java");
