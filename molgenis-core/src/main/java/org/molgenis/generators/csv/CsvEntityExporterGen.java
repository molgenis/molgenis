...
public class CsvEntityExporterGen extends MySqlCreateClassPerTableGen
{
	private static final Logger logger = Logger.getLogger(CsvEntityExporterGen.class);

	@Override
	public String getDescription()
	{
		return "Generates CsvEntityExporter";
	}
