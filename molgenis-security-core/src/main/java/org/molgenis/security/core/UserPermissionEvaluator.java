...
public interface UserPermissionEvaluator {
  /**
   * Returns whether the currently authenticated user has a given {@link Permission} on the given
   * domain object.
   *
   ...
   */
  // TODO: make sure the permission matches the resource type, e.g. subclass this for EntityType
  // resource class
