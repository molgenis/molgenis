...
public class TupleToDateTimeValueConverterTest
{
	...
	public void toCell() throws ValueConverterException
	{
		...
		// assertEquals(new EntityToDateTimeValueConverter().toCell(value, null).getValue(),
		// "2013-06-17T07:45:49+0200");
		assertEquals(new EntityToDateTimeValueConverter().toCell(value, null).getValue(), "2013-06-17 07:45:49");
	}
	...
	public void fromTuple() throws ValueConverterException
	{
		...
		Entity entity = new MapEntity(colName, "2013-06-17 07:45:49");
