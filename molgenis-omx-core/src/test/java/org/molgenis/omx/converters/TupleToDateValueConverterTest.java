...
public class TupleToDateValueConverterTest
{
	...
	public void extractValue() throws ValueConverterException
	{
		...
		value.setValue(date);
		assertEquals(new TupleToDateValueConverter().extractValue(value), "2013-06-17");
	}
	...
	public void fromTuple() throws ValueConverterException
	{
		...
		DateValue value = new TupleToDateValueConverter().fromTuple(tuple, colName, null, null);
