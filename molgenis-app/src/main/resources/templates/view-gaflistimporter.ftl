...
<div class="row">
    <div class="col-md-10 col-md-offset-1 well">
        ...
        <div class="row">
            <div class="col-md-6">
                <form role="form" id="gaflist-import-file-form" method="post" action="${context_url?html}${action?html}"
                      enctype="${enctype?html}"
                      onsubmit="parent.showSpinner(function(){$('.modal-body').html('Work in progress..');});  return true;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span class="pull-right">
									<a id="backButton" href="${context_url?url('UTF-8')}"
                ...
                <#else>
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <span class="pull-right">
									<input id="validateButton" type="submit" value="Validate file"
