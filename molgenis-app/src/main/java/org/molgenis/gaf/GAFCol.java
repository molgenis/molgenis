...
public enum GAFCol
{
	...
	SEQUENCER("sequencer"),
	SAMPLE("Sample"),
	SEQUENCING_START_DATE("sequencingStartDate"),
	RUN("run"),
	FLOWCELL("flowcell"),
	SEQ_TYPE("seqType"),
	BARCODE_1("Barcode 1"),
	...
	PLATES_IN_STOCK__DNA_SEQUENCING("Plates in stock - RNA sequencing"),
	REJECTED_FOR_PROCESSING("Rejected for processing"),
	PLATES_IN_STOCK__DNA_SEQUENCING__WHOLE_GENOME_CAPTURING(
			"Plates in stock - DNA sequencing (whole genome / capturing)"),
	BARCODE_2("Barcode 2"),
	BARCODE("barcode"),
