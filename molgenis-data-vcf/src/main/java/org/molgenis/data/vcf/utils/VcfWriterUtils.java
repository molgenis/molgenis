...
public class VcfWriterUtils {
  ...
  private static String createInfoStringFromAttribute(
    ...
    // FIXME: once we support list of primitives we can calculate based on combination of type and
    // nillable
    sb.append(",Number=.");
    sb.append(",Type=");
    ...
    // value must be surrounded by double-quotes. Double-quote character can be escaped with
    // backslash \ and
    // backslash as \\."
