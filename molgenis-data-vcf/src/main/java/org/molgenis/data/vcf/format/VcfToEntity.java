...
public class VcfToEntity {
  ...
  private void writeInfoFieldsToEntity(VcfRecord vcfRecord, Entity entity) {
    // Set default values for VCF info fields of type 'flag' to false. Note that VcfInfo of a
    // VcfRecord do not
  ...
  private static Map<String, String> createInfoFieldKeyToAttrNameMap(
    ...
    for (VcfMetaInfo info : vcfMeta.getInfoMeta()) {
      // according to the VCF standard it is allowed to have info columns with names that equal
      // default VCF cols.
