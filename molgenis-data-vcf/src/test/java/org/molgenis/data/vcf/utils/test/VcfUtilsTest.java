...
public class VcfUtilsTest extends AbstractMolgenisSpringTest
{
	...
	{
		assertEquals(vcfUtils.getDescription(metaDataCanAnnotate.getAttribute(EFFECT)),
				"EFFECT annotations: 'Alt_Allele | Gene_Name | Annotation | Putative_impact | Gene_ID | Feature_type | Feature_ID | Transcript_biotype | Rank_total | HGVS_c | HGVS_p | cDNA_position | CDS_position | Protein_position | Distance_to_feature | Errors'");
	}

	@Test
	public void testCreateEntityStructureForVcf()
	{
		//public List<Entity> createEntityStructureForVcf(EntityType entityType, String attributeName,
		//Stream<Entity> inputStream)
//		List<Entity> resultEntities = vcfUtils
//				.createEntityStructureForVcf(metaDataCanAnnotate, EFFECT, entities.stream()).collect(Collectors.toList());
//
//		assertEquals(resultEntities.size(), 3);
//
//		assertEquals(resultEntities.get(0).get("identifier"), null);
//		assertEquals(resultEntities.get(0).get("Alt_Allele"), "A");
//		assertEquals(resultEntities.get(0).get("Gene_Name"), "TUBB8");
...
//		assertEquals(resultEntities.get(0).get("Gene_ID"), "TUBB8");
//		assertEquals(resultEntities.get(0).get("Feature_type"), "transcript");
//		assertEquals(resultEntities.get(0).get("Feature_ID"), "NM_177987.2");
//		assertEquals(resultEntities.get(0).get("Transcript_biotype"), "Coding");
//		assertEquals(resultEntities.get(0).get("Rank_total"), "4/4");
//		assertEquals(resultEntities.get(0).get("HGVS_c"), "c.1286C>T");
//		assertEquals(resultEntities.get(0).get("HGVS_p"), "p.Thr429Met");
//		assertEquals(resultEntities.get(0).get("cDNA_position"), "1286/1504");
//		assertEquals(resultEntities.get(0).get("CDS_position"), "1286/1335");
//		assertEquals(resultEntities.get(0).get("Protein_position"), "429/444");
//		assertEquals(resultEntities.get(0).get("Distance_to_feature"), null);
//		assertEquals(resultEntities.get(0).get("Errors"), null);
//		assertEquals(resultEntities.get(0).get("VARIANT").toString(), entity1.toString());
//
//		assertEquals(resultEntities.get(1).get("identifier"), null);
//		assertEquals(resultEntities.get(1).get("Alt_Allele"), "A");
//		assertEquals(resultEntities.get(1).get("Gene_Name"), "TUBB8");
...
//		assertEquals(resultEntities.get(1).get("Gene_ID"), "TUBB8");
//		assertEquals(resultEntities.get(1).get("Feature_type"), "transcript");
//		assertEquals(resultEntities.get(1).get("Feature_ID"), "NM_177987.2");
//		assertEquals(resultEntities.get(1).get("Transcript_biotype"), "Coding");
//		assertEquals(resultEntities.get(1).get("Rank_total"), "4/4");
//		assertEquals(resultEntities.get(1).get("HGVS_c"), "c.1286C>T");
//		assertEquals(resultEntities.get(1).get("HGVS_p"), "p.Thr429Met");
//		assertEquals(resultEntities.get(1).get("cDNA_position"), "1286/1504");
//		assertEquals(resultEntities.get(1).get("CDS_position"), "1286/1335");
//		assertEquals(resultEntities.get(1).get("Protein_position"), "429/444");
//		assertEquals(resultEntities.get(1).get("Distance_to_feature"), null);
//		assertEquals(resultEntities.get(1).get("Errors"), null);
//		assertEquals(resultEntities.get(1).get("VARIANT").toString(), entity2.toString());
//
//		assertEquals(resultEntities.get(2).get("identifier"), null);
...
//		assertEquals(resultEntities.get(2).get("Feature_ID"), "NM_177987.2");
//		assertEquals(resultEntities.get(2).get("Transcript_biotype"), "Coding");
//		assertEquals(resultEntities.get(2).get("Rank_total"), "4/4");
//		assertEquals(resultEntities.get(2).get("HGVS_c"), "c.1286C>T");
//		assertEquals(resultEntities.get(2).get("HGVS_p"), "p.Thr429Met");
//		assertEquals(resultEntities.get(2).get("cDNA_position"), "1286/1504");
//		assertEquals(resultEntities.get(2).get("CDS_position"), "1286/1335");
//		assertEquals(resultEntities.get(2).get("Protein_position"), "429/444");
//		assertEquals(resultEntities.get(2).get("Distance_to_feature"), null);
//		assertEquals(resultEntities.get(2).get("Errors"), null);
//		assertEquals(resultEntities.get(2).get("VARIANT").toString(), entity2.toString());
	}
