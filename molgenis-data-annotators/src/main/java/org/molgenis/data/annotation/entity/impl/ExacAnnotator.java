...
public class ExacAnnotator
{
	...
	public RepositoryAnnotator exac()
	{
		...
		MultiAllelicResultFilter multiAllelicResultFilter = new MultiAllelicResultFilter(Collections
				.singletonList(new DefaultAttributeMetaData(EXAC_AF_ResourceAttributeName, FieldTypeEnum.DECIMAL)));
	...
	Resource exacResource()
	{
		Resource exacTabixResource = new ResourceImpl(EXAC_TABIX_RESOURCE,
				new SingleResourceConfig(AnnotationDbSettings.Meta.EXAC_LOCATION, annotationSettings),
