package org.molgenis.data.annotation.resources.websettings;
...
public class GoNLAnnotatorSettings extends DefaultSettingsEntity
{
	...
	public static class Meta extends DefaultSettingsEntityMetaData
	{
		...
		public void init()
		{
			...
			addAttribute(OVERRIDE_CHROMOSOME_FILES).setDefaultValue("X:gonl.chrX.release4.gtc.vcf.gz").setLabel(
					"Override chromosomes file");
		}
	}
}
