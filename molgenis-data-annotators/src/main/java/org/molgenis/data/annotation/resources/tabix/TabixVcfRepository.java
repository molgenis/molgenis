package org.molgenis.data.annotation.resources.tabix;
...
public class TabixVcfRepository extends VcfRepository
{
	 ...
	 */
	protected Collection<String> getLines(org.molgenis.data.annotation.resources.tabix.TabixReader.Iterator iterator)
	{
