...
public class SnpEffServiceAnnotator implements RepositoryAnnotator
{
	...
	public List<AttributeMetaData> getOutputMetaData()
	{
		...
		metadata.add(transcript_biotype);
		...
		metadata.add(Distance_to_feature);
