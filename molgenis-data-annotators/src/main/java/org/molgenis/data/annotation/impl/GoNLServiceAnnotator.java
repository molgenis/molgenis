...
import org.molgenis.data.annotation.tabix.TabixReader;
...
public class GoNLServiceAnnotator extends VariantAnnotator
{
	...
	public GoNLServiceAnnotator(File gonlR5directory, File inputVcfFile, File outputVCFFile) throws Exception
	{
		...
		VcfUtils.checkPreviouslyAnnotatedAndAddMetadata(inputVcfFile, outputVCFWriter, infoFields, GONL_MAF.substring(VcfRepository.getInfoPrefix().length()));
