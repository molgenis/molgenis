...
import org.molgenis.data.annotation.core.settings.SnpEffAnnotatorSettings;
...
public class SnpEffRepositoryAnnotator extends AbstractRepositoryAnnotator implements RefEntityAnnotator
{
	...
	public void init(SnpEffRunner snpEffRunner, Entity snpEffAnnotatorSettings, DataService dataService,
			VcfAttributes vcfAttributes, EffectsMetaData effectsMetaData)
	{
