...
public abstract class VariantAnnotator extends LocusAnnotator
{
	...
	public EntityMetaData getInputMetaData()
	{
        ...
        DefaultAttributeMetaData chrom = new DefaultAttributeMetaData(CHROMOSOME, MolgenisFieldTypes.FieldTypeEnum.STRING);
        ...
        DefaultAttributeMetaData alt = new DefaultAttributeMetaData(ALTERNATIVE, MolgenisFieldTypes.FieldTypeEnum.STRING);
