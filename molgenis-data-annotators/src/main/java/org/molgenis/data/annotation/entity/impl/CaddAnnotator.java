...
public class CaddAnnotator
{
	...
	public RepositoryAnnotator cadd()
	{
		...
		AnnotatorInfo caddInfo = AnnotatorInfo.create(Status.READY, AnnotatorInfo.Type.PATHOGENICITY_ESTIMATE, "cadd",
	...
	Resource caddResource()
	{
		...
		caddTabixResource = new ResourceImpl(CADD_TABIX_RESOURCE,
				new SingleResourceConfig(AnnotationDbSettings.Meta.CADD_LOCATION, annotationSettings),
