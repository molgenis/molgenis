...
//				attributes);
		EntityAnnotator entityAnnotator = null; // FIXME new AnnotatorImpl(CADD_TABIX_RESOURCE, caddInfo, new LocusQueryCreator(),
...
//		EntityMetaDataImpl repoMetaData = new EntityMetaDataImpl(CADD_TABIX_RESOURCE);
