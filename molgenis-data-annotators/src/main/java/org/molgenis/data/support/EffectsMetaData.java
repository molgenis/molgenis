...
public class EffectsMetaData implements AnnotatorEntityMetaData
{
	...
	public static final DefaultAttributeMetaData FEATURE_TYPE_ATTR = new DefaultAttributeMetaData(FEATURE_TYPE, STRING).setDescription(
	...
	public static final DefaultAttributeMetaData FEATURE_ID_ATTR = new DefaultAttributeMetaData(FEATURE_ID, STRING).setDescription(
	...
	public static final DefaultAttributeMetaData TRANSCRIPT_BIOTYPE_ATTR = new DefaultAttributeMetaData(TRANSCRIPT_BIOTYPE, STRING).setDescription(
	...
	public static final DefaultAttributeMetaData RANK_TOTAL_ATTR = new DefaultAttributeMetaData(RANK_TOTAL, STRING).setDescription(
			"Exon or Intron rank / total number of exons or introns(source:http://snpeff.sourceforge.net)");
	public static final DefaultAttributeMetaData HGVS_C_ATTR = new DefaultAttributeMetaData(HGVS_C, TEXT).setDescription("Variant using HGVS notation (DNA level)(source:http://snpeff.sourceforge.net)");
	public static final DefaultAttributeMetaData HGVS_P_ATTR = new DefaultAttributeMetaData(HGVS_P, STRING).setDescription(
	...
	public static final DefaultAttributeMetaData C_DNA_POSITION_ATTR = new DefaultAttributeMetaData(C_DNA_POSITION, STRING).setDescription(
			"Position in cDNA and trancript’s cDNA length (one based)(source:http://snpeff.sourceforge.net)");
	public static final DefaultAttributeMetaData CDS_POSITION_ATTR = new DefaultAttributeMetaData(CDS_POSITION, STRING).setDescription(
			"Position and number of coding bases (one based includes START and STOP codons)(source:http://snpeff.sourceforge.net)");
	public static final DefaultAttributeMetaData PROTEIN_POSITION_ATTR = new DefaultAttributeMetaData(PROTEIN_POSITION, STRING).setDescription("Position and number of AA (one based, including START, but not STOP)");
	public static final DefaultAttributeMetaData DISTANCE_TO_FEATURE_ATTR = new DefaultAttributeMetaData(DISTANCE_TO_FEATURE, STRING).setDescription(
	...
	public static final DefaultAttributeMetaData ERRORS_ATTR = new DefaultAttributeMetaData(ERRORS, STRING).setDescription(
