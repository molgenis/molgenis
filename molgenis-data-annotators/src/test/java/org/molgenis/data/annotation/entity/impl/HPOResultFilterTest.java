...
import org.molgenis.data.annotation.entity.impl.hpo.HpoResultFilter;
...
import static org.molgenis.data.annotation.entity.impl.hpo.HPORepository.*;
...
public class HPOResultFilterTest extends AbstractMolgenisSpringTest
{
	...
	public void filterResults()
	{
		...
		Entity e1 = new DynamicEntity(entityMeta); // FIXME pass entity meta data instead of null
		e1.set(HPO_ID_COL_NAME, "id1");
		e1.set(HPO_TERM_COL_NAME, "term1");

		Entity e2 = new DynamicEntity(entityMeta); // FIXME pass entity meta data instead of null
		...
		Optional<Entity> result = filter.filterResults(Arrays.asList(e1, e2), new DynamicEntity(resultEntityMeta),
				false); // FIXME pass entity meta data instead of null
