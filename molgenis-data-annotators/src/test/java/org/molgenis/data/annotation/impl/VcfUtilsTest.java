...
public class VcfUtilsTest
{
    ...
    public void beforeMethod() throws IOException
    {
        ...
        * */
        ...
        metaData.addAttributeMetaData(new DefaultAttributeMetaData(VcfRepository.ID, MolgenisFieldTypes.FieldTypeEnum.STRING));
        ...
        metaData.addAttributeMetaData(new DefaultAttributeMetaData(VcfRepository.QUAL, MolgenisFieldTypes.FieldTypeEnum.STRING));
        metaData.addAttributeMetaData(new DefaultAttributeMetaData(VcfRepository.FILTER, MolgenisFieldTypes.FieldTypeEnum.STRING));
        DefaultAttributeMetaData INFO = new DefaultAttributeMetaData(VcfRepository.INFO, MolgenisFieldTypes.FieldTypeEnum.COMPOUND);
        ...
        annotatedEntityMetadata.addAttributeMetaData(new DefaultAttributeMetaData("INFO_ANNO", MolgenisFieldTypes.FieldTypeEnum.STRING));
