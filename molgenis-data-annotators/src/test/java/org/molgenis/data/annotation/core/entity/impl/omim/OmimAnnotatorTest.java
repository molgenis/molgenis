...
public class OmimAnnotatorTest extends AbstractMolgenisSpringTest
{
	...
	public void testOmimAnnotation()
	{
		...
		EntityType inputEntityType = null; //FIXME  entityTypeFactory.create().setFullyQualifiedName("Test");
		...
		EntityType expectedEntityType =  null; //FIXME entityTypeFactory.create().setFullyQualifiedName("Test");
