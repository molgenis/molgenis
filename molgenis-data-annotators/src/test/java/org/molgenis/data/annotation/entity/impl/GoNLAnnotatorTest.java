...
import org.molgenis.data.annotation.resources.websettings.GoNLAnnotatorSettings;
...
import static org.molgenis.data.annotation.entity.impl.GoNLAnnotator.*;
...
public class GoNLAnnotatorTest extends AbstractMolgenisSpringTest
{
	...
	public void testAnnotate2()
	{
		...
		assertEquals(resultEntity.get(GONL_GENOME_AF), "0.0");
