package org.molgenis.data.annotation.core.entity.test;
	...
	public void update() throws IOException
	{
				...
				attributeMetaDataFactory))
		{
			try (AnnotationConfigApplicationContext ctx = new AnnotationConfigApplicationContext(
					"org.molgenis.data.annotation.core","org.molgenis.data.annotation.cmd"))
			{
				...
				caddAnnotator.getCmdLineAnnotatorSettingsConfigurer()
						.addSettings(ResourceUtils.getFile(getClass(), "/cadd/AnnotatorUpdateIT_CADD_ESP6500SI_7lines.tsv.gz").getPath());
