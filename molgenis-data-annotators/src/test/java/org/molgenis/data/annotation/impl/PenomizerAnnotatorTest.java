...
public class PenomizerAnnotatorTest {
    ...
    public void beforeMethod() throws IOException
    {
        ...
        metaDataCanAnnotate.addAttributeMetaData(new DefaultAttributeMetaData(HpoServiceAnnotator.HPO_TERMS, MolgenisFieldTypes.FieldTypeEnum.STRING));
        ...
        metaDataCantAnnotate.addAttributeMetaData(new DefaultAttributeMetaData(VcfRepository.getInfoPrefix() + "ANN",
                MolgenisFieldTypes.FieldTypeEnum.TEXT));
        metaDataCantAnnotate.addAttributeMetaData(new DefaultAttributeMetaData(HpoServiceAnnotator.HPO_TERMS, MolgenisFieldTypes.FieldTypeEnum.INT));
        ...
        entity.set(HpoServiceAnnotator.HPO_TERMS,
                "HP:0001300,HP:0007325,HP:0002015");
        ...
        annotator = new PhenomizerServiceAnnotator(molgenisSettings, null, urlPinger);
    }
