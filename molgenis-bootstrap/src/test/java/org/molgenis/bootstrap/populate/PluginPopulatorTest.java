...
public class PluginPopulatorTest extends AbstractMockitoTest
{
	...
	public void testPopulate() throws Exception
	{
		...
		MolgenisPlugin newPlugin = new MolgenisPlugin("plugin0", "Plugin #0", "uri", "fullUri");
		...
		MolgenisPlugin changedPlugin = new MolgenisPlugin("plugin1", "Plugin #1 - updated", "uri", "fullUri");
	...
	{
		MolgenisPlugin molgenisPlugin0 = new MolgenisPlugin("plugin0", "Plugin #0", "uri", "fullUri");
		when(pluginRegistry.getPlugin("plugin0")).thenReturn(molgenisPlugin0);
		MolgenisPlugin molgenisPlugin1 = new MolgenisPlugin("plugin1", "Plugin #1", "uri", "fullUri");
