...
public class IdCardIndexerController extends MolgenisPluginController
{
	...
	@PreAuthorize("hasAnyRole('ROLE_SU, ROLE_ENTITY_WRITE_"+IdCardBiobank.ENTITY_NAME+", ROLE_ENTITY_READ_"+IdCardBiobank.ENTITY_NAME+"')")
	...
	@PreAuthorize("hasAnyRole('ROLE_SU, ROLE_ENTITY_WRITE_"+IdCardBiobank.ENTITY_NAME+"')")
	@ResponseBody
