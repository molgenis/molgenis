...
public class MysqlRepositoryTest extends AbstractTestNGSpringContextTests
{
	...
	// TODO: uncomment + add test for Mref
	// @Test
	// public void testAddAttributeXrefDefaultValue()
	// {
	// DefaultEntityMetaData metaData = new DefaultEntityMetaData("addAttributeXrefDV");
	// metaData.addAttribute("idAttr", ROLE_ID).setDataType(INT);
	// Repository repo = metaDataRepositories.addEntityMeta(metaData);
	//
	// DefaultEntityMetaData refMetaData = new DefaultEntityMetaData("addAttributeXrefDV_Ref");
	// refMetaData.addAttribute("refIdAttr", ROLE_ID).setDataType(STRING);
	// refMetaData.addAttribute("refValue").setDataType(STRING);
	// Repository refRepo = metaDataRepositories.addEntityMeta(refMetaData);
	//
	// // add one ref entity
	// MapEntity refEntity0 = new MapEntity(refMetaData);
	// refEntity0.set("refIdAttr", "ref0");
	// refEntity0.set("refValue", "ref value");
	// refRepo.add(refEntity0);
	//
	// // add first entity
	// MapEntity entity0 = new MapEntity(metaData);
	// entity0.set("idAttr", 0);
	...
	//
	// // add attribute
	// DefaultAttributeMetaData damd = new DefaultAttributeMetaData("newAttr").setDataType(XREF)
	// .setRefEntity(refMetaData).setDefaultValue("ref1");
	// coll.addAttribute("addAttributeXrefDV", damd);
	//
	// EntityMetaData newMetaData = repo.getEntityMetaData();
	//
	// // add second entity that doesn't set newAttr
	...
	// repo.add(entity1);
	//
	// // add third entity that does set newAttr to another ref entity
	// MapEntity refEntity1 = new MapEntity(refMetaData);
	// refEntity1.set("refIdAttr", "ref1");
	// refEntity1.set("refValue", "test");
	// refRepo.add(refEntity1);
	//
	// MapEntity entity2 = new MapEntity(newMetaData);
	// entity2.set("idAttr", 2);
	// entity2.set("newAttr", "ref1");
	// repo.add(entity2);
	//
	// Entity result0 = repo.findOne(0);
	// assertEquals(result0.getEntity("newAttr").get("refValue"), "ref value");
	//
	// Entity result1 = repo.findOne(1);
	// assertEquals(result1.getEntity("newAttr").get("refValue"), "ref value");
	//
	// Entity result2 = repo.findOne(2);
	// assertNotEquals(result2.getEntity("newAttr").get("refValue"), "ref value");
	// }
}
