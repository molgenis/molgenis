...
public class MysqlRepositoryMrefTest extends MysqlRepositoryAbstractDatatypeTest
{
	...
	public void test() throws Exception
	{
		...
		entity.set("stringRef", Arrays.asList(new String[]{"ref1","ref2"}));
		entity.set("intRef", Arrays.asList(new Integer[]{1, 2}));
		...
		for (Entity e : mrefRepo.findAll(new QueryImpl().eq("identifier","one")))
		{
            ...
            Assert.assertEquals(e.getList("stringRef"), Arrays.asList(new String[]{"ref1","ref2"}));
			Assert.assertEquals(e.get("intRef"), "1,2");
            Assert.assertEquals(e.getIntList("intRef"), Arrays.asList(new Integer[]{1,2}));
		}
