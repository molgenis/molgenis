...
public class EntityTypeValidatorTest extends AbstractMockitoTest
{
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp =
			"Entity \\[entity\\] does not contain any attributes. "
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp = "Entity \\[entity\\] contains multiple attributes with name \\[id\\]")
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp = "Entity \\[entity\\] is missing required ID attribute")
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp = "Entity \\[entity\\] ID attribute \\[id\\] is not part of the entity attributes")
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp = "Entity \\[entity\\] ID attribute \\[id\\] type \\[COMPOUND\\] is not allowed")
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp = "Entity \\[entity\\] ID attribute \\[id\\] is not a unique attribute")
	...
	@Test(expectedExceptions = MolgenisValidationException.class, expectedExceptionsMessageRegExp = "Entity \\[entity\\] ID attribute \\[id\\] is not a non-nillable attribute")
