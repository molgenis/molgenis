...
public class EntityAttributesValidatorTest extends AbstractMockitoTest
{
	...
	public void checkRangeMinOnly()
	{
		...
		List<ValidationResult> constraints = entityAttributesValidator.validate(entity, intRangeMinMeta);
	...
	public void checkRangeMaxOnly()
	{
		...
		List<ValidationResult> constraints = entityAttributesValidator.validate(entity, intRangeMaxMeta);
		assertTrue(constraints.isEmpty());
	}
	...
	public void checkXrefValid(AttributeType attrType)
	{
		...
		List<ValidationResult> constraints = entityAttributesValidator.validate(entity0, entity0.getEntityType());
	...
	public void validateNullableExpression()
	{
		...
		List<ValidationResult> constraintViolations = entityAttributesValidator.validate(entity, entityType);
		List<ValidationResult> expectedConstraintViolations = asList(
				new AttributeValueValidationResult(NOT_NULL, AttributeValue.create(attr1, null)),
				new AttributeValueValidationResult(NOT_NULL, AttributeValue.create(attr2, null)));
		assertEquals(constraintViolations, expectedConstraintViolations);
	}
