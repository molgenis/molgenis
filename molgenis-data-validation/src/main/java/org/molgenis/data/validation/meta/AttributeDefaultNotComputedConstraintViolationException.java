 ...
 */
public class AttributeDefaultNotComputedConstraintViolationException extends DataIntegrityViolationException
{
	private static final String ERROR_CODE = "V13";
	private final Attribute attribute;

	public AttributeDefaultNotComputedConstraintViolationException(Attribute attribute)
	{
		super(ERROR_CODE);
