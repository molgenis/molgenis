...
/**
 * Same as {@link SimpleRedirectInvalidSessionStrategy} except for XMLHttpRequests in which case a
 * status code is returned instead of redirection.
 */
public class AjaxAwareInvalidSessionStrategy implements InvalidSessionStrategy {
  private static final RequestMatcher REQUEST_MATCHER_XML_HTTP_REQUEST =
  ...
  AjaxAwareInvalidSessionStrategy(String invalidSessionUrl) {
    ...
    this.simpleRedirectInvalidSessionStrategy =
        new SimpleRedirectInvalidSessionStrategy(invalidSessionUrl);
  }
