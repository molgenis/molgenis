...
public class AuthenticationAuthoritiesUpdaterImpl implements AuthenticationAuthoritiesUpdater {
  ...
  public Authentication updateAuthentication(
      Authentication authentication, List<GrantedAuthority> updatedAuthorities) {
    Authentication newAuthentication;
    if (authentication instanceof TwoFactorAuthenticationToken) {
      TwoFactorAuthenticationToken twoFactorAuthenticationToken =
          (TwoFactorAuthenticationToken) authentication;
      newAuthentication =
          new TwoFactorAuthenticationToken(
              authentication.getPrincipal(),
              authentication.getCredentials(),
              updatedAuthorities,
              twoFactorAuthenticationToken.getVerificationCode(),
              twoFactorAuthenticationToken.getSecretKey());
      ...
      newAuthentication =
          new AnonymousAuthenticationTokenDecorator(
  ...
  private static final class AnonymousAuthenticationTokenDecorator
      extends AnonymousAuthenticationToken {
  ...
  private static final class RunAsUserTokenDecorator extends RunAsUserToken {
    ...
    private RunAsUserTokenDecorator(
        RunAsUserToken runAsUserToken, List<GrantedAuthority> authorities) {
      super(
          "dummyKey",
          runAsUserToken.getPrincipal(),
          runAsUserToken.getCredentials(),
          authorities,
