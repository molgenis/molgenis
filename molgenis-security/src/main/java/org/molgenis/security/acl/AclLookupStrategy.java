...
/**
 * Lookup strategy for object identities with String identifiers.
 *
 * @see org.springframework.security.acls.jdbc.BasicLookupStrategy
 */
public class AclLookupStrategy implements LookupStrategy
{
	 ...
	 */
	public AclLookupStrategy(DataSource dataSource, AclCache aclCache,
