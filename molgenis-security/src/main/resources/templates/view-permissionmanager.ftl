			...
			<div class="row">
                <div class="col-md-3">
    				<ul class="nav nav-pills nav-stacked" role="tablist">
    					<li class="active"><a href="#plugin-permission-manager" role="tab" data-toggle="tab">Plugin Permissions</a></li>
    					<li><a href="#entity-class-permission-manager" role="tab" data-toggle="tab">Entity Class Permissions</a></li>  
