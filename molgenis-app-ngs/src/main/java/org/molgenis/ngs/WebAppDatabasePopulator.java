...
import org.molgenis.ngs.plugins.HomePlugin;
...
public class WebAppDatabasePopulator extends MolgenisDatabasePopulator
{
	...
	protected void initializeApplicationDatabase(Database database) throws Exception
	{
		...
		runtimePropertyMap.put(GuiService.KEY_APP_NAME, "NGS");
		...
		permissionService.setPermissionOnPlugin(HomePlugin.class.getSimpleName(), anonymousUser.getId(),
				Permission.READ);
