...
var FormControlGroup = React.createClass({
	...
	render : function() {
		...
		for (var i = 0; i < attributes.length; ++i) {
			...
			// IE9 does not support the autofocus attribute, focus the first
			// visible input manually
		...
		var Fieldset = fieldset({}, legend({}, this.props.attr.label), p({}, this.props.attr.description), div({
			className : 'row'
		}, div({
