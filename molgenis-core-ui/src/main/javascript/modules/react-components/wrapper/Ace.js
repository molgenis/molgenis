...
ace.config.set("basePath", "/js/components/ace/src-min-noconflict");
...
var Ace = React.createClass({
	...
	_updateAce : function() {
		...
		if (editor.getValue() !== this.state.value) {
			// I THINK this always means the value got updated
			// programmatically so we can safely update the editor's value
