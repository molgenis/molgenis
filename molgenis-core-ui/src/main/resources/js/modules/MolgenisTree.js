define(function(require, exports, module) {
	...
	/**
	 * @memberOf MolgenisTree
	 * TODO how to handle these $.fn functions??
	 */
	exports.prototype.generateTreeAndConfig = function(options) {
			...
			var treeConfig = {
				...
				'lazyLoad' : function(e, data) {
					...
					data.result = $.Deferred(function(dfd) {
						restApi.getAsync(target, {
							'expand' : [ 'attributes' ]
						}, function(entityMetaData) {
							var children = createChildren(entityMetaData.attributes, node.data.refEntityDepth + increaseDepth, settings.maxRefEntityDepth,
									entityMetaData.languageCode, function() {
				...
				'click' : function(e, data) {
					if (data.targetType === 'title' || data.targetType === 'icon') {
						if (settings.onAttributeClick) {
							var attr = data.node.data.attribute, node = _this_.getRefParentNode(data.node);
							if (node !== null) {
