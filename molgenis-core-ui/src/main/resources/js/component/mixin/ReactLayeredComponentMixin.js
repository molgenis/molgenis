define(function(require, exports, module) {
	 ...
	 * 
	 * @memberOf ReactLayeredComponentMixin
	 */
	var ReactLayeredComponentMixin = {
		...
		componentDidMount : function() {
			...
			// It's also better for accessibility and makes stacking a snap
			// (since components will stack
			// in mount order).
		...
		_renderLayer : function() {
			...
			// componentDidUpdate(), you're effectively
			// creating a "wormhole" that funnels React's hierarchical updates
			// through to a DOM node on an
