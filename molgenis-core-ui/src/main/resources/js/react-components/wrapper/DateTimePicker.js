define(function(require, exports, module) {
	...
	/**
	 * React component for Datepicker
	 * (http://eonasdan.github.io/bootstrap-datetimepicker/)
	 * 
	 * @memberOf component.wrapper
	 */
	// FIXME should use controlled input
	var DateTimePicker = React.createClass({
		...
		render : function() {
			...
			return (div({
				className : 'input-group date group-append',
				ref : 'datepicker'
			}, input({
				type : 'text',
			...
			!required ? span({
				...
				className : 'glyphicon glyphicon-remove empty-date-input',
				ref : 'clearbtn'
			})) : null, span({
				className : 'input-group-addon datepickerbutton'
			}, span({
