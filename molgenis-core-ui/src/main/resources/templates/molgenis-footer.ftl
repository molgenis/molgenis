        	...
        	<div class="row footer">
        		<div class="col-md-12">
            		<p class="text-muted text-center small">
	            		...
	            		<em>This database was generated using the open source <a href="http://www.molgenis.org">MOLGENIS database generator</a><#if molgenis_version?has_content> version ${molgenis_version!?html}</#if><#if molgenis_build_date?has_content> built on ${molgenis_build_date!?html}</#if>.<br>Please cite <a href="http://www.ncbi.nlm.nih.gov/pubmed/21210979">Swertz et al (2010)</a> or <a href="http://www.ncbi.nlm.nih.gov/pubmed/17297480">Swertz &amp; Jansen (2007)</a> on use.</em>
					</p>
