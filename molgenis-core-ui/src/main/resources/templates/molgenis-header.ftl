...
<head>
    ...
    <#else>
        ...
        <link rel="stylesheet" href="<@resource_href "/@molgenis-ui/menu/dist/context.css"/>" type="text/css">
...
<body class="mg-page">
    ...
    <#else>
        ...
        <script type=text/javascript src="<@resource_href "/@molgenis-ui/menu/dist/context.umd.js"/>"></script>
    </#if>
