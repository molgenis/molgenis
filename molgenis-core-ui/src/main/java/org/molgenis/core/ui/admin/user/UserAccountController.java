...
public class UserAccountController extends PluginController {
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        code = 403,
        message = "Access denied. You need write permission on the UserAccount plugin",
        response = ErrorMessageResponse.class),
    @ApiResponse(
        code = 400,
        message = "Bad request. You need to provide a valid language code",
        response = ErrorMessageResponse.class)
  })
  ...
  public void updateAccount(@Valid @NotNull AccountUpdateRequest updateRequest) {
    ...
    if (isNotEmpty(updateRequest.getMiddleNames()))
    ...
    if (isNotEmpty(updateRequest.getDepartment()))
  ...
  private String validatePasswordInUpdateRequest(
      @Valid @NotNull AccountUpdateRequest updateRequest) {
  ...
  @ApiResponses({
    ...
    @ApiResponse(
        code = 500,
        message = "Something went wrong retrieving the recoverycodes",
        response = ErrorMessageResponse.class)
  })
  ...
  @ApiResponses({
    @ApiResponse(
        code = 200,
        message = "Returns a list of generated recoverycodes",
        response = Map.class),
    @ApiResponse(
        code = 500,
        message = "Something went wrong generating the recoverycodes",
        response = ErrorMessageResponse.class)
  })
