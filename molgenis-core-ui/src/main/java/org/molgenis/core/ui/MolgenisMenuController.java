...
public class MolgenisMenuController {
  ...
  private @CheckForNull String getQueryString(UiMenuItem menuItem) {
  ...
  private String getForwardPluginUri(String pluginId, @CheckForNull String pathRemainder) {
    return getForwardPluginUri(pluginId, pathRemainder, null);
  }

  /** package-private for testability */
  String getForwardPluginUri(
      String pluginId, @CheckForNull String pathRemainder, @CheckForNull String queryString) {
