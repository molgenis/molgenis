...
public class StyleServiceImpl implements StyleService {
  ...
  public Set<Style> getAvailableStyles() {
    Stream<StyleSheet> styleEntities =
        dataService.findAll(StyleSheetMetadata.STYLE_SHEET, StyleSheet.class);
  ...
  public StyleSheet findThemeByName(String themeName) {
    Query<StyleSheet> findByName =
        new QueryImpl<StyleSheet>().eq(StyleSheetMetadata.NAME, themeName);
