...
public class XmlMolgenisUiMenuTest {
  ...
  public void getItems() {
    ...
    when(permissionService.hasPermission(new PluginIdentity("plugin1"), VIEW_PLUGIN))
        .thenReturn(true);
    when(permissionService.hasPermission(new PluginIdentity("plugin2"), VIEW_PLUGIN))
        .thenReturn(false);
    when(permissionService.hasPermission(new PluginIdentity("plugin3"), VIEW_PLUGIN))
        .thenReturn(true);
  ...
  public void isAuthorized() {
    ...
    when(permissionService.hasPermission(new PluginIdentity(pluginId), VIEW_PLUGIN))
        .thenReturn(true);
  ...
  public void isAuthorized_partiallyAuthorized() {
    ...
    when(permissionService.hasPermission(new PluginIdentity(plugin1Id), VIEW_PLUGIN))
        .thenReturn(false);
    when(permissionService.hasPermission(new PluginIdentity(plugin2Id), VIEW_PLUGIN))
        .thenReturn(true);
  ...
  public void isAuthorized_notAuthorized() {
    ...
    when(permissionService.hasPermission(new PluginIdentity("something"), VIEW_PLUGIN))
        .thenReturn(false);
