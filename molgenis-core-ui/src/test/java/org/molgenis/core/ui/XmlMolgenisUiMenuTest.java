...
public class XmlMolgenisUiMenuTest
{
	...
	public void getItems()
	{
		...
		when(permissionService.hasPermission(new PluginIdentity("plugin1"), PluginActions.VIEW_PLUGIN)).thenReturn(
				true);
		when(permissionService.hasPermission(new PluginIdentity("plugin2"), PluginActions.VIEW_PLUGIN)).thenReturn(
				false);
		when(permissionService.hasPermission(new PluginIdentity("plugin3"), PluginActions.VIEW_PLUGIN)).thenReturn(
				true);
	...
	public void isAuthorized()
	{
		...
		when(permissionService.hasPermission(new PluginIdentity(pluginId), PluginActions.VIEW_PLUGIN)).thenReturn(true);
	...
	public void isAuthorized_partiallyAuthorized()
	{
		...
		when(permissionService.hasPermission(new PluginIdentity(plugin1Id), PluginActions.VIEW_PLUGIN)).thenReturn(
				false);
		when(permissionService.hasPermission(new PluginIdentity(plugin2Id), PluginActions.VIEW_PLUGIN)).thenReturn(
				true);
	...
	public void isAuthorized_notAuthorized()
	{
		...
		when(permissionService.hasPermission(new PluginIdentity("something"), PluginActions.VIEW_PLUGIN)).thenReturn(
				false);
