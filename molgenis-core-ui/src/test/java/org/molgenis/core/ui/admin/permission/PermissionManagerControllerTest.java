...
//
//	private RepositoryIdentity entityIdentity1;
//	private RepositoryIdentity entityIdentity2;
//	private RepositoryIdentity entityIdentity3;
//
...
//
//		entityIdentity1 = new RepositoryIdentity(entityType1);
//		entityIdentity2 = new RepositoryIdentity(entityType2);
//		entityIdentity3 = new RepositoryIdentity(entityType3);
//
...
//		cumulativeEntityPermissionWritemeta.set(RepositoryPermission.WRITEMETA)
...
//		cumulativeEntityPermissionWrite.set(RepositoryPermission.WRITE)
//									   .set(RepositoryPermission.READ)
//									   .set(RepositoryPermission.COUNT);
//		cumulativeEntityPermissionRead = new CumulativePermission();
//		cumulativeEntityPermissionRead.set(RepositoryPermission.READ).set(RepositoryPermission.COUNT);
//		cumulativeEntityPermissionCount = new CumulativePermission();
//		cumulativeEntityPermissionCount.set(RepositoryPermission.COUNT);
//	}
//
...
//		expected.setEntityIds(ids);
//
//		assertEquals(permissionManagerController.getUserRepositoryPermissions("1"), expected);
//	}
//
//	@Test
...
//		when(webRequest.getParameter("radio-3")).thenReturn("read");
//
//		ObjectIdentity objectIdentity1 = new RepositoryIdentity(entityType1);
//		ObjectIdentity objectIdentity2 = new RepositoryIdentity(entityType2);
//		ObjectIdentity objectIdentity3 = new RepositoryIdentity(entityType3);
//
//		MutableAcl acl1 = mock(MutableAcl.class);
//		MutableAcl acl2 = mock(MutableAcl.class);
//		MutableAcl acl3 = mock(MutableAcl.class);
