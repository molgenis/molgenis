...
test('Test if the Jobs component renders running, success and failed jobs correctly', assert => {
	...
	'<div><div class="row"><div class="col-md-5"><div class="panel panel-primary"><div class="panel-heading">Running Jobs</div><div class="panel-body"><div><p>TEST job job<div class="progress background-lightgrey"><div class="progress-bar progress-bar-primary progress-bar-striped active" role="progressbar" style="min-width:2em;width:100%;">Test (started by Tape)</div></div></p></div></div></div></div><div class="col-md-7"><div><div class="panel panel-primary"><div class="panel-heading">Finished Jobs</div><div class="panel-body"><table class="table table-striped"><thead><th>Status</th><th>Runtime</th><th>Type</th><th>Message</th><th>Started</th><th>Finished</th><th>Link to entity</th></thead><tbody><tr><td>SUCCESS</td><td>15 minutes</td><td>TEST job</td><td>Test (started by Tape)</td><td>Fri, Jan 1, 2100 12:15 AM</td><td>in 84 years</td><td>URL to TapeTest</td></tr><tr><td>FAILED</td><td>15 minutes</td><td>TEST job</td><td>Test (started by Tape)</td><td>Mon, Jan 1, 2300 12:15 AM</td><td>in 284 years</td><td>URL to TapeTest</td></tr></tbody></table></div></div></div></div></div></div>', 
	'Jobs component renders what we expect');
...
test('Test if the RunningJobs component renders job progressbars', assert => {
	...
	'RunningJobs component renders what we expect');
...
test('Test if the JobTable renders a table with job information', assert => {
	...
	assert.equals(tree.toString(), 
	'<div><div class="panel panel-primary"><div class="panel-heading">Finished Jobs</div><div class="panel-body"><table class="table table-striped"><thead><th>Status</th><th>Runtime</th><th>Type</th><th>Message</th><th>Started</th><th>Finished</th><th>Link to entity</th></thead><tbody><tr><td>SUCCESS</td><td>15 minutes</td><td>TEST job</td><td>Test (started by Tape)</td><td>Fri, Jan 1, 2100 12:15 AM</td><td>in 84 years</td><td>URL to TapeTest</td></tr><tr><td>RUNNING</td><td>15 minutes</td><td>TEST job</td><td>Test (started by Tape)</td><td>Wed, Jan 1, 2200 12:15 AM</td><td>in 184 years</td><td>URL to TapeTest</td></tr><tr><td>FAILED</td><td>15 minutes</td><td>TEST job</td><td>Test (started by Tape)</td><td>Mon, Jan 1, 2300 12:15 AM</td><td>in 284 years</td><td>URL to TapeTest</td></tr></tbody></table></div></div></div>', 
	'JobTable component renders what we expect');
...
test('Test if the Job component renders a succeeded job correctly', assert => {
	...
	'Job component renders what we expect');
