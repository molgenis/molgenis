...
test('Testing ProgressBar component', (t) => {
	t.test('Rendering a progress bar', (t) => {
		...
		t.test('Assert the progress bar equals what we expect', (t) => {
			 ...
			 '<div class="progress"><div class="progress-bar progress-bar-primary progress-bar-striped active" role="progressbar" style="min-width:2em;width:100%;">testing the progress bar</div></div>',
