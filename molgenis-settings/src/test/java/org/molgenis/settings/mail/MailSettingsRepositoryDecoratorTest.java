...
public class MailSettingsRepositoryDecoratorTest {
  ...
  public void beforeClass() {
    initMocks(this);
    mailSettingsRepositoryDecorator =
        new MailSettingsRepositoryDecorator(delegateRepository, mailSenderFactory);
  }
  ...
  public Object[][] addDontTest() {
    return new Object[][] {
      {false, "username", "password"}, {true, null, "password"}, {true, "username", null}
    };
  }
  ...
  public void testAddInvalidSettings() {
    ...
    doThrow(IllegalStateException.class)
        .when(mailSenderFactory)
        .validateConnection(any(MailSettingsImpl.class));
  ...
  @Test(dataProvider = "addDontTest")
  public void testUpdateDontTestConnection(
