...
@Controller
@RequestMapping(URI)
public class BiobankConnectController extends MolgenisPlugin
{
	public static final String URI = MolgenisPlugin.PLUGIN_URI_PREFIX + "biobankconnect";
	...
	public BiobankConnectController()
	{
		super(URI);
	}
