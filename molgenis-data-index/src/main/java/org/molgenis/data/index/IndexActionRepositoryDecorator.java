...
/**
 * {@link Repository} decorator that registers changes with a {@link
...
public class IndexActionRepositoryDecorator extends AbstractRepositoryDecorator<Entity> {
  ...
  public IndexActionRepositoryDecorator(
    ...
    getEntityType()
        ...
        .forEach(
            mappedByAttr -> {
              ...
              entity
                  .getEntities(mappedByAttr.getName())
                  .forEach(
                      refEntity ->
                          indexActionRegisterService.register(
                              mappedByAttrRefEntity, refEntity.getIdValue()));
            });
        ...
        .forEach(
            inversedByAttr -> {
              ...
              if (refEntity != null) {
                ...
                indexActionRegisterService.register(
                    inversedByAttrRefEntity, refEntity.getIdValue());
              }
            });
  }
}
