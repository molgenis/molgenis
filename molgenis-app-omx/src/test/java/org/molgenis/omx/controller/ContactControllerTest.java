...
import org.molgenis.omx.controller.ContactControllerTest.Config;
...
public class ContactControllerTest extends AbstractTestNGSpringContextTests
{
	...
	{
		mockMvc.perform(get(ContactController.URI)).andExpect(status().isOk());
	}
	...
	public static class Config
	{
		...
		{
			return new ContactController(molgenisSettings());
		}
