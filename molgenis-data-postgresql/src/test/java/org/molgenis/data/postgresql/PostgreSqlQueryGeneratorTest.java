...
public class PostgreSqlQueryGeneratorTest
{
	...
	public void getSqlCreateTable()
	{
		...
		when(refEntityTypeString.getSimpleName()).thenReturn("refEntityStr");
		...
		when(refEntityTypeInt.getSimpleName()).thenReturn("refEntityInt");
	...
	public void getSqlCreateForeignKey()
	{
		...
		when(refEntityType.getSimpleName()).thenReturn("refEntity");
		...
		String expectedSql = "ALTER TABLE \"entity#fc2928f6\" ADD CONSTRAINT \"entity#fc2928f6_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntity#07f902bf\"(\"refIdAttr\")";
	...
	public void getJunctionTableSelect()
	{
		...
		assertEquals(PostgreSqlQueryGenerator.getSqlJunctionTableSelect(entityType, attr, 3),
				"SELECT \"idAttr\",\"order\",\"attr\" FROM \"entityName#fc2928f6_attr\" WHERE \"idAttr\" in (?, ?, ?) ORDER BY \"idAttr\",\"order\"");
	}
	...
	public void getSqlSelectMref()
	{
		...
		when(ref1Meta.getSimpleName()).thenReturn("Ref1");
		...
		when(ref2Meta.getSimpleName()).thenReturn("Ref2");
	...
	public static Iterator<Object[]> getSqlAddColumnProvider()
	{
		...
		when(refIdAttrInt.getDataType()).thenReturn(INT);
		EntityType refEntityTypeInt = mock(EntityType.class);
		when(refEntityTypeInt.getId()).thenReturn("refEntityIntId");
		when(refEntityTypeInt.toString()).thenReturn("refEntityInt");
		when(refEntityTypeInt.getName()).thenReturn("refEntityInt");
		when(refEntityTypeInt.getSimpleName()).thenReturn("refEntityInt");
		when(refEntityTypeInt.getIdAttribute()).thenReturn(refIdAttrInt);

		return Arrays.asList(new Object[] { BOOL, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" boolean" },
				new Object[] { CATEGORICAL, true, refEntityTypeInt,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" integer,ADD CONSTRAINT \"entity#fc2928f6_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityInt#15855f86\"(\"refIdAttrInt\")" },
				new Object[] { DATE, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" date" },
				new Object[] { DATE_TIME, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" timestamp" },
				new Object[] { DECIMAL, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" double precision" },
				new Object[] { EMAIL, true, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255)" },
				new Object[] { ENUM, true, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255),ADD CONSTRAINT \"entity#fc2928f6_attr_chk\" CHECK (\"attr\" IN ('enum0, enum1'))" },
				new Object[] { FILE, true, refEntityTypeString,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255),ADD CONSTRAINT \"entity#fc2928f6_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#7fc12697\"(\"refIdAttrStr\")" },
				new Object[] { HTML, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" text" },
				new Object[] { HYPERLINK, true, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255)" },
				new Object[] { INT, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" integer" },
				new Object[] { LONG, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" bigint" },
				new Object[] { SCRIPT, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" text" },
				new Object[] { STRING, true, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255)" },
				new Object[] { TEXT, true, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" text" },
				new Object[] { XREF, true, refEntityTypeString,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255),ADD CONSTRAINT \"entity#fc2928f6_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#7fc12697\"(\"refIdAttrStr\")" },
				new Object[] { BOOL, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" boolean NOT NULL" },
				new Object[] { CATEGORICAL, false, refEntityTypeInt,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" integer NOT NULL,ADD CONSTRAINT \"entity#fc2928f6_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityInt#15855f86\"(\"refIdAttrInt\")" },
				new Object[] { DATE, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" date NOT NULL" },
				new Object[] { DATE_TIME, false, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" timestamp NOT NULL" },
				new Object[] { DECIMAL, false, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" double precision NOT NULL" },
				new Object[] { EMAIL, false, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255) NOT NULL" },
				new Object[] { ENUM, false, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255) NOT NULL,ADD CONSTRAINT \"entity#fc2928f6_attr_chk\" CHECK (\"attr\" IN ('enum0, enum1'))" },
				new Object[] { FILE, false, refEntityTypeString,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255) NOT NULL,ADD CONSTRAINT \"entity#fc2928f6_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#7fc12697\"(\"refIdAttrStr\")" },
				new Object[] { HTML, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" text NOT NULL" },
				new Object[] { HYPERLINK, false, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255) NOT NULL" },
				new Object[] { INT, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" integer NOT NULL" },
				new Object[] { LONG, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" bigint NOT NULL" },
				new Object[] { SCRIPT, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" text NOT NULL" },
				new Object[] { STRING, false, null,
						"ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" character varying(255) NOT NULL" },
				new Object[] { TEXT, false, null, "ALTER TABLE \"entity#fc2928f6\" ADD \"attr\" text NOT NULL" },
	...
	public void getSqlDropColumn()
	{
		...
		assertEquals(PostgreSqlQueryGenerator.getSqlDropColumn(entityType, attr),
				"ALTER TABLE \"entity#fc2928f6\" DROP COLUMN \"attr\"");
	}
	...
	public void getSqlCreateJunctionTableIndex()
	{
		...
		assertEquals(PostgreSqlQueryGenerator.getSqlCreateJunctionTableIndex(entityType, attr),
				"CREATE INDEX \"entity#fc2928f6_attr_idAttr_idx\" ON \"entity#fc2928f6_attr\" (\"idAttr\")");
	}
}