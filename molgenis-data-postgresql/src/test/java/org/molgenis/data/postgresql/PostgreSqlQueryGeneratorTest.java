...
class PostgreSqlQueryGeneratorTest {
  @Test
  void getSqlSetNotNull() {
  ...
  @Test
  void getSqlCreateFunctionValidateUpdate() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
  ...
  @Test
  void getSqlDropFunctionValidateUpdate() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
  ...
  @Test
  void getSqlCreateUpdateTrigger() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute attr0 = when(mock(Attribute.class).getName()).thenReturn("attr0").getMock();
    when(attr0.getIdentifier()).thenReturn("attr0Id");
  ...
  @Test
  void getSqlCreateForeignKeySelfReferencing() {
    Attribute idAttr = when(mock(Attribute.class).getName()).thenReturn("idAttr").getMock();
    when(idAttr.getIdentifier()).thenReturn("idAttrId");
    when(idAttr.getDataType()).thenReturn(STRING);
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
  ...
  @Test
  void getSqlCreateCheckConstraint() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute attr = when(mock(Attribute.class).getName()).thenReturn("attr").getMock();
    when(attr.getIdentifier()).thenReturn("attrId");
  ...
  @Test
  void getSqlDropCheckConstraint() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute attr = when(mock(Attribute.class).getName()).thenReturn("attr").getMock();
    when(attr.getIdentifier()).thenReturn("attrId");
  ...
  @Test
  void getSqlDropCheckConstraintWrongDataType() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute attr = when(mock(Attribute.class).getName()).thenReturn("attr").getMock();
    when(attr.getIdentifier()).thenReturn("attrId");
  ...
  @Test
  void getSqlCreateJunctionTable() {
    Attribute refIdAttr = when(mock(Attribute.class).getName()).thenReturn("refIdAttr").getMock();
    when(refIdAttr.getIdentifier()).thenReturn("refIdAttrId");
  ...
  @Test
  void getSqlCreateJunctionTableSelfReferencing() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute idAttr = when(mock(Attribute.class).getName()).thenReturn("idAttr").getMock();
    when(idAttr.getIdentifier()).thenReturn("idAttrId");
  ...
  @Test
  void getSqlInsertJunctionInversedBy() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute idAttr = when(mock(Attribute.class).getName()).thenReturn("idAttr").getMock();
    when(idAttr.getIdentifier()).thenReturn("idAttrId");
  ...
  @ParameterizedTest
  @MethodSource("getSqlSelectOneToManyMappedByProvider")
  void getSqlSelectOneToManyMappedBy(
  ...
  @Test
  void getSqlSortSortWithUniqueAttribute() {
    Attribute idAttr = when(mock(Attribute.class).getName()).thenReturn("idAttr").getMock();
    when(idAttr.getIdentifier()).thenReturn("idAttrId");
    when(idAttr.getDataType()).thenReturn(STRING);
    when(idAttr.isUnique()).thenReturn(true);
  ...
  @Test
  void getSqlSortSortWithoutUniqueAttribute() {
    Attribute idAttr = when(mock(Attribute.class).getName()).thenReturn("idAttr").getMock();
    when(idAttr.getIdentifier()).thenReturn("idAttrId");
    when(idAttr.getDataType()).thenReturn(STRING);
    when(idAttr.isUnique()).thenReturn(true);
  ...
  @Test
  void getSqlSortOnUnselectedMref() {
    Package package_ = when(mock(Package.class).getId()).thenReturn("org_molgenis").getMock();
  ...
  static Iterator<Object[]> getSqlAddColumnProvider() {
    ...
    return Arrays.asList(
            ...
            new Object[] {
              ...
              true,
              refEntityTypeInt,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" integer,ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityInt#78255ee1\"(\"refIdAttrInt\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              DATE,
              null,
            ...
            new Object[] {
              ...
              true,
              refEntityTypeString,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" character varying(255),ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#305ca1a9\"(\"refIdAttrStr\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              HTML,
              null,
            ...
            new Object[] {
              ...
              false,
              refEntityTypeInt,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" integer NOT NULL,ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityInt#78255ee1\"(\"refIdAttrInt\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              DATE,
              null,
            ...
            new Object[] {
              ...
              false,
              refEntityTypeString,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" character varying(255) NOT NULL,ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#305ca1a9\"(\"refIdAttrStr\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              HTML,
              null,
            ...
            new Object[] {
              ...
              false,
              refEntityTypeInt,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" integer NOT NULL DEFAULT 1,ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityInt#78255ee1\"(\"refIdAttrInt\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              DATE,
              "2010-01-13",
            ...
            new Object[] {
              ...
              false,
              refEntityTypeString,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" character varying(255) NOT NULL DEFAULT 'refEntityId',ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#305ca1a9\"(\"refIdAttrStr\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              HTML,
              "html",
            ...
            new Object[] {
              ...
              false,
              refEntityTypeString,
              "ALTER TABLE \"entityTypeId#c34894ba\" ADD \"attr\" character varying(255) NOT NULL DEFAULT 'entityTypeId',ADD CONSTRAINT \"entityTypeId#c34894ba_attr_fkey\" FOREIGN KEY (\"attr\") REFERENCES \"refEntityStr#305ca1a9\"(\"refIdAttrStr\") DEFERRABLE INITIALLY DEFERRED"
            },
            new Object[] {
              BOOL,
              Boolean.TRUE.toString(),
  ...
  @ParameterizedTest
  @MethodSource("getSqlAddColumnProvider")
  void getSqlAddColumn(
  ...
  static Iterator<Object[]> getSqlAddColumnInvalidTypeProvider() {
    return Arrays.asList(
            new Object[] {COMPOUND, ColumnMode.EXCLUDE_DEFAULT_CONSTRAINT},
            ...
            new Object[] {MREF, ColumnMode.INCLUDE_DEFAULT_CONSTRAINT})
        .iterator();
  }

  @ParameterizedTest
  @MethodSource("getSqlAddColumnInvalidTypeProvider")
  void getSqlAddColumnInvalidType(AttributeType attrType, ColumnMode columnMode) {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    Attribute attr = when(mock(Attribute.class).getName()).thenReturn("attr").getMock();
    when(attr.getDataType()).thenReturn(attrType);
    assertThrows(
  ...
  static Iterator<Object[]> generateSqlColumnDefaultConstraintProvider() {
    return Arrays.asList(
            new Object[] {null, STRING, false},
            new Object[] {null, XREF, false},
            new Object[] {"str", STRING, true},
            new Object[] {"refEntityId", XREF, true})
        .iterator();
  }

  @ParameterizedTest
  @MethodSource("generateSqlColumnDefaultConstraintProvider")
  void generateSqlColumnDefaultConstraint(
      String defaultValue, AttributeType attributeType, boolean expectedResult) {
  ...
  @Test
  void getSqlCreateJunctionTableIndex() {
    EntityType entityType = when(mock(EntityType.class).getId()).thenReturn("entity").getMock();
    when(entityType.getId()).thenReturn("entityTypeId");
    Attribute attr = when(mock(Attribute.class).getName()).thenReturn("attr").getMock();
    when(attr.getIdentifier()).thenReturn("attrId");
  ...
  @Test
  void testGetSqlUpdateAttribute() {
    String idAttributeName = "MyIdAttribute";
    Attribute idAttribute =
        when(mock(Attribute.class).getName()).thenReturn(idAttributeName).getMock();
    when(idAttribute.getDataType()).thenReturn(STRING);
