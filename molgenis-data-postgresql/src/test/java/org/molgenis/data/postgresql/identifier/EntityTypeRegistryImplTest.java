...
public class EntityTypeRegistryImplTest extends AbstractMockitoTest {
  ...
  @Mock private Attribute mrefAttr;
  ...
  public void setUpBeforeMethod() {
    ...
    entityTypeDescription =
        EntityTypeDescription.create(
            "org_molgenis_test_many_packages_deep",
            ImmutableMap.of(
                "stringAttribute",
                AttributeDescription.create("stringAttribute"),
  ...
  public void testDeleteMrefAttrInTransaction() {
    ...
    assertEquals(
        entityTypeRegistryImpl.getEntityTypeDescription("org_molgenis_test_many#2409e1c6_mref"),
        entityTypeDescription,
        "Other threads should still see old metadata");
