...
public class OntologyTagServiceImpl implements OntologyTagService {
  ...
  @RunAsSystem
  private @NotNull Entity findAttributeEntity(String entityTypeId, String attributeName) {
  ...
  private <S> SemanticTag<S, OntologyTerm, Ontology> asTag(S subjectType, Entity tagEntity) {
