...
public interface SemanticSearchService
{
	 ...
	 */
	default AttributeSearchResults findAttributes(EntityType sourceEntityType, EntityType targetEntityType,
	...
	/**
	 * Find {@link Attribute attributes} in a source {@link EntityType entity type} that match attributes in a target
	 * entity type.
	 */
	default EntityTypeSearchResults findAttributes(EntityType sourceEntityType, EntityType targetEntityType)
	{
	 ...
	 */
	AttributeSearchResults findAttributes(EntityType sourceEntityType, EntityType targetEntityType,
			Attribute targetAttribute, Set<String> searchTerms);

	/**
	 * Find {@link Attribute attributes} in a source {@link EntityType entity type} that match attributes in a target
	 * entity type. Optionally constrain the search using one or more search terms.
	 */
	EntityTypeSearchResults findAttributes(EntityType sourceEntityType, EntityType targetEntityType,
