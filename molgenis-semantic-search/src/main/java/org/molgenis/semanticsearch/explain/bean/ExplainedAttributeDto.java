...
public abstract class ExplainedAttributeDto
{
	...
	{
		return new AutoValue_ExplainedAttributeDto(attributeToMap(attribute), Collections.emptySet(), false);
	}
	...
	public static ExplainedAttributeDto create(Attribute attribute,
			...
			boolean highQuality)
	{
		return new AutoValue_ExplainedAttributeDto(attributeToMap(attribute), Sets.newHashSet(explainedQueryStrings),
				highQuality);
	}
