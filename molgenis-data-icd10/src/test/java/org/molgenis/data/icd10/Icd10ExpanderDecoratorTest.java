...
public class Icd10ExpanderDecoratorTest extends AbstractMockitoTest
{
	...
	{
		when(queryTransformer.transformQuery(query, ICD10_ENTITY_TYPE_ID, EXPAND_ATTRIBUTE)).thenReturn(
				transformedQuery);
		icd10ExpanderDecorator = new Icd10ExpanderDecorator(decoratedRepository, queryTransformer, ICD10_ENTITY_TYPE_ID,
				EXPAND_ATTRIBUTE);
	}
