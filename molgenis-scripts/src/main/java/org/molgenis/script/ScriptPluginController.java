...
public class ScriptPluginController extends MolgenisPluginController
{
	...
	public String listScripts(Model model)
	{
		...
		model.addAttribute("scripts", Lists.newArrayList(dataService.findAllAsIterable(Script.ENTITY_NAME, Script.class)));
		model.addAttribute("parameters",
				Lists.newArrayList(dataService.findAllAsIterable(ScriptParameter.ENTITY_NAME, ScriptParameter.class)));
		return "view-scripts";
	}
}
