...
class CopyState {
  ...
  @CheckForNull private final Package targetPackage;
  ...
  private CopyState(@CheckForNull Package targetPackage, Progress progress) {
    this.targetPackage = targetPackage;
    this.progress = requireNonNull(progress);
  }

  public static CopyState create(@CheckForNull Package targetPackage, Progress progress) {
