...
public class EntityMetaDataMetaData1_5 extends DefaultEntityMetaData
{
	...
	public EntityMetaDataMetaData1_5()
	{
		super(ENTITY_NAME);
		...
		addAttribute(TAGS).setDataType(MREF).setRefEntity(new TagMetaData1_5());
		addAttribute(ATTRIBUTES).setDataType(MREF).setRefEntity(new AttributeMetaDataMetaData1_5());
	}
