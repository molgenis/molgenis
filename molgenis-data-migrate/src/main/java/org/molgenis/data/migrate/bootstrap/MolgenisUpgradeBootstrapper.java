...
import org.molgenis.data.migrate.version.Step36UpdateAceNavigatorForFunctions;
...
public class MolgenisUpgradeBootstrapper {
  ...
  public void bootstrap() {
    ...
    upgradeService.addUpgrade(new Step36UpdateAceNavigatorForFunctions(dataSource));
