    ...
    verify(jdbcTemplate)
        .execute(
            "alter table \"sys_md_Attribute#c8d9a252\" add column \"maxLength\" integer;\n"
                ...
                + "    VALUES ('aaaac6flvg7gtbroh7raetqaca', 'maxLength', 'sys_md_Attribute', 24, 'int', null, null, null, null, null, null, null, null, null, true, false, true, 'Max length', 'Maximum length for string attributes. If not set, falls back to the default for the attribute type. N.B. If you lower this value, existing data will be truncated!', false, null, null, null, null, false, false, null, null, '$(''maxLength'').isNull().or($(''type'').matches(/^(email|html|hyperlink|script|string|text)$/)).value()', null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null);");
  }
}
