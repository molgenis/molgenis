...
public class DataExplorerDownloadHandlerTest extends AbstractMockitoTest {
  ...
  @Mock private QueryImpl<Entity> query;
  @Mock private Entity entity1;
  @Mock private Entity entity2;
  @Mock private Entity refEntity1;
  @Mock private Entity refEntity2;
  ...
  public static Object[][] writeToExcelDataProvider() {
    return new Object[][] {
      new Object[] {
        ...
        DataRequest.EntityValues.ENTITY_LABELS,
        ImmutableMap.of(
            "sys_set_thousandgenomes",
            asList(
                asList("attr1", "attr2"),
                asList("entity1attr1", "refEntity1Label"),
                asList("entity2attr1", "refEntity2Label")))
      },
      new Object[] {
        DataRequest.ColNames.ATTRIBUTE_LABELS,
        DataRequest.EntityValues.ENTITY_IDS,
        ImmutableMap.of(
            "sys_set_thousandgenomes",
            asList(
                asList("attr1Label", "attr2Label"),
                asList("entity1attr1", "refEntity1Id"),
  ...
  private List<List<String>> readCsv(File file) throws IOException, InvalidFormatException {
    try (CSVReader reader =
        new CSVReader(new InputStreamReader(new FileInputStream(file), Charset.forName("UTF-8")))) {
