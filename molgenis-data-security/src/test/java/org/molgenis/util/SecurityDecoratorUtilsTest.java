...
public class SecurityDecoratorUtilsTest extends AbstractTestNGSpringContextTests
{
	...
	@Test(expectedExceptions = MolgenisPermissionException.class, expectedExceptionsMessageRegExp = "No \\[READ\\] permission on entity type \\[entityTypeLabel\\] with id \\[entityTypeId\\]")
	...
	@Test(expectedExceptions = MolgenisPermissionException.class, expectedExceptionsMessageRegExp = "No \\[COUNT\\] permission on entity type \\[entityTypeLabel\\] with id \\[entityTypeId\\]")
