...
//					   .hasPermission(new RepositoryIdentity(entityType0Name), RepositoryPermission.COUNT);
//		doReturn(true).when(permissionService)
//					  .hasPermission(new RepositoryIdentity(entityType1Name), RepositoryPermission.COUNT);
...
//		verify(mutableAclService).createAcl(new RepositoryIdentity(entityTypeId));
//	}
//
//	@Test
//	public void query()
...
//					   .hasPermission(new RepositoryIdentity(entityType1Name), RepositoryPermission.COUNT);
//		doReturn(true).when(permissionService)
//					  .hasPermission(new RepositoryIdentity(entityType2Name), RepositoryPermission.COUNT);
...
//		when(permissionService.hasPermission(new RepositoryIdentity(entityType0Name),
...
//				RepositoryPermission.WRITEMETA)).thenReturn(true);
//
//		EntityType entityType = mock(EntityType.class);
//		when(entityType.getId()).thenReturn("entityTypeId").getMock();
//		repo.delete(entityType);
//		verify(mutableAclService).deleteAcl(new RepositoryIdentity(entityTypeId), true);
...
//		String entityTypeId = "entityTypeId";
//		when(permissionService.hasPermission(new RepositoryIdentity(entityTypeId),
//				RepositoryPermission.WRITEMETA)).thenReturn(false);
//
//		EntityType entityType = mock(EntityType.class);
//		when(entityType.getId()).thenReturn("entityTypeId").getMock();
