...
public class PackagePermissionUtils
{
	 ...
	 */
	public static boolean isReadablePackage(Package aPackage, UserPermissionEvaluator userPermissionEvaluator)
	{
	...
	private static boolean isPermittedPackage(Package aPackage, UserPermissionEvaluator userPermissionEvaluator,
