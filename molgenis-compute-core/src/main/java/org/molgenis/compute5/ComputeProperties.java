...
public class ComputeProperties
{
	...
	public void parseCommandLine(String[] args)
	{
		...
		try
		{
			...
			this.parametersToOverwrite = cmd.getOptionValue(Parameters.PARAMETERS_TO_OVERWRITE_CMDLINE, "");
	...
	public Options createOptions()
	{
		...
		options.addOption(OptionBuilder
				...
				.withLongOpt(Parameters.PARAMETERS_TO_OVERWRITE_CMDLINE).create(Parameters.PARAMETERS_TO_OVERWRITE_CMDLINE_OPTION));
