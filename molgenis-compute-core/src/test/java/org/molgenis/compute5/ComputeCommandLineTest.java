...
public class ComputeCommandLineTest
{
	...
	public void test2() throws ComputeException, ParseException, ClassNotFoundException, IOException
	{
		...
		this.runtest(path, new String[]{"--path","/Users/mdijkstra/Documents/work/gitmavennew/molgenis/molgenis-compute-core/src/main/resources/workflows/demoNBIC2","--rundir",path, "-g"});
	}
