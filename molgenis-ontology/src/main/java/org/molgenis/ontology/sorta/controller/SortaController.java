...
public class SortaController extends PluginController {
  ...
  public EntityCollectionResponse retrieveSortaJobResults(
      @RequestBody SortaServiceRequest sortaServiceRequest) {
  ...
  public SortaServiceResponse findMatchingOntologyTerms(@RequestBody Map<String, Object> request) {
    ...
    if (request.containsKey("sortaJobExecutionId")
        ...
        && request.containsKey(IDENTIFIER)
  ...
  private String startMatchJob(
    ...
    // TODO determine whether multiple match jobs during the same session results in wrong file
    // usage
