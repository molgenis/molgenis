...
<div class="row">
	<div class="col-md-offset-2 col-md-8">
		<p class="pull-right" style="font-size:16pt;font-family: arial, helvetica, sans-serif;"><strong>S</strong>ystem for&nbsp;<strong>O</strong>ntology-based&nbsp;<strong>R</strong>e-coding and&nbsp;<strong>T</strong>echnical&nbsp;<strong>A</strong>nnotation</p>
	</div>	
</div>
<br>
<div class="row">
...
<div class="row">
	<div class="col-md-offset-2 col-md-8" style="font-size:14pt; font-family: arial, helvetica, sans-serif; text-align: justify;">
		<p style="font-size: 14pt; font-family: arial, helvetica, sans-serif;">SORTA, a matching tool built in <a href="https://github.com/molgenis/molgenis" target="_blank">MOLGENIS</a>, 
		is able to semi-automatically match data values with standard codes such as ontologies or local terminologies. For each data value, SORTA provides a list of the most relevant standard codes based on the lexical similarity in percentage, users can then pick the correct matches from the suggested list.</p>
	</div>
</div>
<div class="row">
	<div class="col-md-offset-2 col-md-8">
...
<div class="row"> 
	<div class="col-md-offset-2 col-md-8">
		...
		<p style="font-size: 14pt; font-family: arial, helvetica, sans-serif; text-align: justify;">
			SORTA is built based on Lucene in combination with the N-gram string matching algorithm to achieve high performance and accuracy.
			Lucene matching scores are too abstract for users to understand and they are not comparable between each other.
			Therefore we use the N-gram algorithm to re-calculate the similarity scores (in percentages) between data values and the concepts retrieved by Lucene. 
		...
		<ul style="font-size: 14pt; font-family: arial, helvetica, sans-serif;">
			...
			<li>Step 3 - The N-gram algorithm is applied to re-calculate the similarity scores between data values and concepts retrieved by Lucene.</li>
			<li>Step 4 - Users can pick the correct matches from the list of concepts sorted based on N-gram similarity scores.</li>
		</ul>
	</div>
</div>
<br>
<div class="row">
	<div class="col-md-offset-2 col-md-8">
		<img src="https://molgenis26.target.rug.nl/downloads/sorta/figures/figure.1.png" alt="Not available" class="img-responsive" style="border:1px solid grey" />
	</div>
</div>
<br>
<div class="row">
