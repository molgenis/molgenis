...
public class SortaServiceImplTest
{
	...
	public void beforeClass()
	{
		...
		MapEntity ontologyEntity = new MapEntity();
		...
		when(dataService.findAll(OntologyMetaData.ENTITY_NAME)).thenReturn(Arrays.asList(ontologyEntity));

		// ########################### TEST ONE ###########################
		// Mock the first ontologyterm entity only with name
		MapEntity ontologyTermSynonym_1 = new MapEntity();
		...
		MapEntity ontologyTermSynonym_2 = new MapEntity();
		...
		List<QueryRule> finalQueryRules = Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
				ontologyEntity), new QueryRule(Operator.AND), disMaxRegularQueryRule);

		when(dataService.findAll(OntologyTermMetaData.ENTITY_NAME, new QueryImpl(finalQueryRules).pageSize(50)))
				.thenReturn(Arrays.asList(ontologyTermEntity_1, ontologyTermEntity_2));

		// DataService action for n-gram matching ontologyterm synonyms
		QueryRule disMaxNGramQueryRule = new QueryRule(Arrays.asList(new QueryRule(
				OntologyTermMetaData.ONTOLOGY_TERM_SYNONYM, Operator.FUZZY_MATCH_NGRAM, "hear impair")));
		disMaxNGramQueryRule.setOperator(Operator.DIS_MAX);
		when(
				dataService.findAll(
						OntologyTermMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
								ontologyEntity), new QueryRule(Operator.AND), disMaxNGramQueryRule)).pageSize(10)))
				.thenReturn(Arrays.asList(ontologyTermEntity_1, ontologyTermEntity_2));
		...
		MapEntity ontologyTermSynonym_3 = new MapEntity();
		...
		MapEntity ontologyTermDynamicAnnotation_3_1 = new MapEntity();
		...
		QueryRule annotationQueryRule = new QueryRule(Arrays.asList(new QueryRule(
				OntologyTermDynamicAnnotationMetaData.NAME, Operator.EQUALS, "OMIM"), new QueryRule(Operator.AND),
		...
		when(
				dataService.findAll(OntologyTermDynamicAnnotationMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(annotationQueryRule)).pageSize(Integer.MAX_VALUE))).thenReturn(
				Arrays.asList(ontologyTermDynamicAnnotation_3_1));
		...
		when(
				dataService.findAll(
						OntologyTermMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
								ontologyEntity), new QueryRule(Operator.AND),
								new QueryRule(OntologyTermMetaData.ONTOLOGY_TERM_DYNAMIC_ANNOTATION, Operator.IN,
										Arrays.asList(ontologyTermDynamicAnnotation_3_1)))).pageSize(Integer.MAX_VALUE)))
				.thenReturn(Arrays.asList(ontologyTermEntity_3));

		// DataService action for elasticsearch regular matching ontologyterm synonyms
		QueryRule disMaxRegularQueryRule_2 = new QueryRule(Arrays.asList(new QueryRule(
				OntologyTermMetaData.ONTOLOGY_TERM_SYNONYM, Operator.FUZZY_MATCH, "input~0.8")));
		disMaxRegularQueryRule_2.setOperator(Operator.DIS_MAX);
		when(
				dataService.findAll(
						OntologyTermMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
								ontologyEntity), new QueryRule(Operator.AND), disMaxRegularQueryRule_2)).pageSize(49)))
				.thenReturn(Collections.emptyList());

		// DataService action for n-gram matching ontologyterm synonyms
		QueryRule disMaxNGramQueryRule_2 = new QueryRule(Arrays.asList(new QueryRule(
				OntologyTermMetaData.ONTOLOGY_TERM_SYNONYM, Operator.FUZZY_MATCH_NGRAM, "input")));
		disMaxNGramQueryRule_2.setOperator(Operator.DIS_MAX);
		when(
				dataService.findAll(
						OntologyTermMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
								ontologyEntity), new QueryRule(Operator.AND), disMaxNGramQueryRule_2)).pageSize(10)))
				.thenReturn(Collections.emptyList());
		...
		// DataService action for elasticsearch regular matching ontologyterm synonyms
		QueryRule disMaxRegularQueryRule_3 = new QueryRule(Arrays.asList(new QueryRule(
				OntologyTermMetaData.ONTOLOGY_TERM_SYNONYM, Operator.FUZZY_MATCH,
		...
		when(
				dataService.findAll(
						OntologyTermMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
								ontologyEntity), new QueryRule(Operator.AND), disMaxRegularQueryRule_3)).pageSize(50)))
				.thenReturn(Arrays.asList(ontologyTermEntity_4));

		// DataService action for elasticsearch ngram matching ontologyterm synonyms
		QueryRule disMaxNGramQueryRule_3 = new QueryRule(Arrays.asList(new QueryRule(
				OntologyTermMetaData.ONTOLOGY_TERM_SYNONYM, Operator.FUZZY_MATCH_NGRAM,
		...
		when(
				dataService.findAll(
						OntologyTermMetaData.ENTITY_NAME,
						new QueryImpl(Arrays.asList(new QueryRule(OntologyTermMetaData.ONTOLOGY, Operator.EQUALS,
								ontologyEntity), new QueryRule(Operator.AND), disMaxNGramQueryRule_3)).pageSize(10)))
				.thenReturn(Arrays.asList(ontologyTermEntity_4));
	}
	...
	public void findOntologyTermEntities()
	{
		...
		assertEquals(secondMatch_test1.getDouble(SortaServiceImpl.COMBINED_SCORE).intValue(), new Double(85).intValue());
