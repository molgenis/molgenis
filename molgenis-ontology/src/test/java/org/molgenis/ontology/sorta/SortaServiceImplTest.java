...
public class SortaServiceImplTest
{
	...
	//
	//		sortaService = new SortaServiceImpl(dataService, new InformationContentService(dataService), new OntologyTermHitEntityMetaData());
	//
	...
	//
	//		when(dataService.findAll(ONTOLOGY)).thenReturn(Arrays.asList(ontologyEntity).stream());
	//
	//		// ########################### TEST ONE ###########################
	//		// Mock the first ontologyterm entity only with name
	//		Entity ontologyTermSynonym_1 = new MapEntity();
	//		ontologyTermSynonym_1.set(OntologyTermSynonymMetaData.ONTOLOGY_TERM_SYNONYM_ATTR, "hearing impairment");
	//		Entity ontologyTermEntity_1 = new MapEntity(new OntologyTermMetaData());
	...
	//		ontologyTermSynonym_2.set(OntologyTermSynonymMetaData.ONTOLOGY_TERM_SYNONYM_ATTR, "mixed hearing impairment");
	//		Entity ontologyTermEntity_2 = new MapEntity(new OntologyTermMetaData());
	...
	//
	//		when(dataService.findAll(ONTOLOGY_TERM, new QueryImpl<Entity>(finalQueryRules).pageSize(50)))
	...
	//		ontologyTermSynonym_3.set(OntologyTermSynonymMetaData.ONTOLOGY_TERM_SYNONYM_ATTR, "ot_3");
	//
	...
	//		Entity ontologyTermEntity_3 = new MapEntity(new OntologyTermMetaData());
	...
	//		ontologyTermSynonym_4_1.set(OntologyTermSynonymMetaData.ONTOLOGY_TERM_SYNONYM_ATTR, "protruding eye");
	//
	//		Entity ontologyTermSynonym_4_2 = new MapEntity();
	//		ontologyTermSynonym_4_2.set(OntologyTermSynonymMetaData.ONTOLOGY_TERM_SYNONYM_ATTR, "proptosis");
	//
	//		Entity ontologyTermSynonym_4_3 = new MapEntity();
	//		ontologyTermSynonym_4_3.set(OntologyTermSynonymMetaData.ONTOLOGY_TERM_SYNONYM_ATTR, "Exophthalmos");
	//
	//		// Mock ontologyTerm entity based on the previous entities defined
	//		Entity ontologyTermEntity_4 = new MapEntity(new OntologyTermMetaData());
