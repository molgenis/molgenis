...
Standard codes (ontologies) can be imported using the [EMX format](../import-data/ref-emx.md) , the model can be browsed and viewed as a UML diagram as well as a flat list in the webbrowser. 
