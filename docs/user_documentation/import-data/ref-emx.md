...
#### visible
true/false to indicate whether the attribute can be seen by users. Can also contain a javascript expression to dynamically decide if the attribute should be shown or not. See the [Expressions](ref-expressions.md) section for a syntax description.
