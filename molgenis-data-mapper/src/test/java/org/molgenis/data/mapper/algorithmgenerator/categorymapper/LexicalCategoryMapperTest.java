...
{
	LexicalCategoryMapper lexicalCategoryMapper = new LexicalCategoryMapper(Arrays.asList(new PositiveCategoryRule(),
			new NegativeCategoryRule()));
	...
	public void findBestCategoryMatch()
	{
		...
		Assert.assertEquals(lexicalCategoryMapper.findBestCategoryMatch(Category.create(1, "male"), targetCategories1),
				maleCategory);
		Assert.assertEquals(
