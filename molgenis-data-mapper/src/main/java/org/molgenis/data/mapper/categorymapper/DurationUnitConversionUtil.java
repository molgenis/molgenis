...
public class DurationUnitConversionUtil
{
	...
	static
	{
		DURATION_UNITS = Arrays.asList(SI.SECOND, NonSI.MINUTE, NonSI.HOUR, NonSI.DAY, NonSI.WEEK, NonSI.MONTH,
				NonSI.YEAR);
	...
	public static Unit<?> findDurationUnit(String description)
	{
		...
		{
			if (tokens.contains(unit.toString().toLowerCase())) return unit;
		}
		return null;
	}
