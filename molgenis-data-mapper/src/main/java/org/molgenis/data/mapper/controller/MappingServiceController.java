...
public class MappingServiceController extends MolgenisPluginController
{
	...
	/**
	 * Helper method to store the auto generated tags in the Tag repository
	 * 
	 * @param request
	 *            {@link AutoTagRequest} containing entity name and ontologyIRIs
	 * @param relationIRI
	 * @param autoGeneratedTags
	 */
