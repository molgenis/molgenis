...
<div class="tab-content">
    ...
    <div class="tab-pane" id="uml">
        <#--<div id="zoom-in-out" class="btn-group hidden-print">-->
            ...
            <#--</button>-->
            <#--<!-- Automatic scaling &ndash;&gt;-->
            <#--<div class="btn-group">-->
                <#--<button id="reset" type="button" class="btn btn-default btn-sm" aria-haspopup="true"-->
                        <#--aria-expanded="false" data-toggle="tooltip" data-placement="top" title="Reset">-->
                    <#--Reset </span>-->
                <#--</button>-->
                ...
                <#--</ul>-->
            <#--</div>-->
            <#--<button type="button" id="zoom-out" class="btn btn-default btn-sm" data-toggle="tooltip"-->
                    <#--data-placement="bottom" title="Zoom out">-->
